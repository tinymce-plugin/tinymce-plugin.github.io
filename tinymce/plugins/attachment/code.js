...
!function() {
	...
	function i(o) {
		o.focus(),pickFile(Qeider).then(function (e){
	...
	var e = function(n) {
		...
		r = function(a, t, n) {
			...
			t.size > s ? (e = d(s), a.notificationManager.open({
				...
				type: "warning",
				timeout: 5e3
			})) : (i = a.getParam("attachment_upload_handler"), o =  a.getParam('attachment_icons_url', 'https://unpkg.com/@npkg/tinymce-plugins/plugins/attachment/icons'), c = a.dom.uniqueId(), r = "attachment_" + c, l = d(t.size), p = o + "/" +
			function(e) {
				if (e) {
					var t = e.lastIndexOf(".");
