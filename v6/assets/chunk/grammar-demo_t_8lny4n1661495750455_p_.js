...
</code><div class="language-text" >vue</div></pre>`}};n.template=`<Preview class="demo-grammar-demo_t_8lny4n1661495750455_p_" :source="source()">
...
</code><div class="language-text" >html</div></pre>`},sourceCode(){return'<iframe scrolling="no" width="100%" style="width:100%;margin:auto 0;border:0px; min-height: 519px"  onload="autoIframeHeight(this)"  src="/v6/demo/demo-grammar-demo_t_8lny4n1661495750455_p_1661495755379/index.html"></iframe>'}};t.template=`<PreviewIframe class="demo-grammar-demo_t_8lny4n1661495750455_p_" idx="Demo1"  :source="source()" :sourceCode="sourceCode()">
...
</code><div class="language-text" >vue</div></pre>`}};l.template=`<Preview class="demo-grammar-demo_t_8lny4n1661495750455_p_" :source="source()">
                                <template v-slot:demo><div>
 <h1>\u63D2\u4EF6demo\u5C55\u793A\u533A\u57DF</h1>
  <div class="vueDemo">
    <tinymce-vue v-model="content" :init="tinymceOptions" ></tinymce-vue>
...
</code><div class="language-text" >vue</div></pre>`}};a.template=`<PreviewVue2 class="demo-grammar-demo_t_8lny4n1661495750455_p_"  :template="template()"  :source="source()">
...
</code><div class="language-text" >html</div></pre>`},sourceCode(){return'<iframe scrolling="no" width="100%" style="width:100%;margin:auto 0;border:0px; min-height: 519px"  onload="autoIframeHeight(this)"  src="/v6/demo/demo-grammar-demo_t_8lny4n1661495750455_p_1661495755426/index.html"></iframe>'}};e.template=`<PreviewIframe class="demo-grammar-demo_t_8lny4n1661495750455_p_" idx="Demo5"  :source="source()" :sourceCode="sourceCode()">
...
<Demo0 data-isComponent="vue" class="demo-grammar-demo_t_8lny4n1661495750455_p_" />
<demoGroup>
 <demoGroupItem title=" Javascript ">
<Demo1  data-isComponent="iframe" />
 </demoGroupItem>
 <demoGroupItem title="Vue" active>
<Demo2 data-isComponent="vue" class="demo-grammar-demo_t_8lny4n1661495750455_p_" />
 </demoGroupItem>
 <demoGroupItem title="Vue2">
<Demo3 data-isComponent="vue" class="demo-grammar-demo_t_8lny4n1661495750455_p_" />
 </demoGroupItem>
 <demoGroupItem title="React">
<Demo4  data-isComponent="react"  class="demo-grammar-demo_t_8lny4n1661495750455_p_" />
 </demoGroupItem>
</demoGroup>
...
<codeBoxItem title="TinyMCE"><iframe scrolling="no" style="width:100%;margin:auto 0;border:0px; min-height: 220px"  onload="autoIframeHeight(this)"  src="/v6/demo/codebox/demo-grammar-demo_t_8lny4n1661495750455_p_1661495755442/index.html"></iframe></codeBoxItem></codeBox></div></div><PagesRouter  docPath="guide/contributing/writing-guide/grammar-demo.md" mapType="docs" docRepo="tinymce-plugin-docs" pagesName="grammar-demo_t_8lny4n1661495750455_p_" />`});export{v as default};
