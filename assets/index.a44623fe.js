var At=(m,d)=>()=>(d||m((d={exports:{}}).exports,d),d.exports);var Tt=At((E,Y)=>{/*! 
...
*/(function(m,d){typeof E=="object"&&typeof Y<"u"?d(E):typeof define=="function"&&define.amd?define(["exports"],d):(m=typeof globalThis<"u"?globalThis:m||self,d(m["tinymce-plugin"]={}))})(globalThis,function(m){let d=tinymce,F=d.util.Tools,x=d.html.Node;d.html.Schema;let H=d.util.XHR,L=d.util.I18n,W=new d.html.Serializer().serialize,Z=new d.html.DomParser().parse,f={};window.tp$State=f;let c=(t,e)=>{let o=e?e.match(new RegExp(t+':(.+?)"?[;}]')):"";return o?o[1]:!1};function M(t,e,o,a){t.tp$Style.mapping&&t.tp$Style.mapping[""+e.getAttribute("data-id")]&&(t.tp$Style.mapping[""+e.getAttribute("data-id")].specialStyle[""+o]=a)}let u={customTags:{}},S=Object.keys,h=function(){return h=Object.assign||function(t){for(var e,o=1,a=arguments.length;o<a;o++){e=arguments[o];for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&(t[n]=e[n])}return t},h.apply(this,arguments)},G=Object.hasOwnProperty;var K=function(t){return t==null},Q=function(t){return!K(t)};const k=t=>{if(typeof t=="object")return JSON.stringify(t).replace(/"([-A-Za-z]+?)":""[,}]/g,"").replace(/,/gi,";").replace(/{/gi,"").replace(/}/gi,"").replace(/"/gi,"")},z=t=>typeof t=="string"&&t!=="{}"?(t=JSON.stringify(t),JSON.parse(("{"+t.replace(/:/g,'": "').replace(/;\s*/g,'","')+"}").replace(/,\"\"\}$/,"}"))):t,_=(t,e)=>{const o=e.match(new RegExp(`.${t}\\s*\\{([\\s\\S]+)\\}`));return o&&o[1]?o[1].replace(/\}([\s\S]+)/,"").trim():""};var tt=function(t,e){return G.call(t,e)},et=function(t,e,o,a){a===void 0&&(a=null);var n=t.attr(o);return Q(n)?n:tt(e,o)?null:a};const A=t=>t.replace(/[-|\_](\w)/g,function(e,o){return o.toUpperCase()}),at=t=>t.replace(/([A-Z])/g,"_$1").toLowerCase().replace(/\-/g,"_"),ot=t=>t.replace(/([A-Z])/g,"-$1").toLowerCase().replace(/\_/g,"-");var nt=function(t,e){let o="";if(!t)return"";for(e=A(e);t.nodeName!=="P"&&t.nodeName!=="LI"&&t.nodeName!=="DIV"&&t.nodeName!=="BODY";){if(t.style[e]){o=t.style[e];break}t=t.parentNode}return o};let w=(t,e)=>{let o="";return o+=t["tp-buttons"]?'.tp-buttons[data-tp-style="'+e+'"] {'+t["tp-buttons"]+`}
...
`:"",o};const st=(t,e,o)=>{!o&&(o=e*100);let a={id:null,outTime:o,outId:null};a.id=setInterval(n=>{t(()=>{clearTimeout(n.outId),clearInterval(n.id)})},e,a),a.outId=setTimeout(()=>{a.id&&clearInterval(a.id)},a.outTime)};let v=function(t,e){return typeof t[e]=="function"?t[e]:typeof u.customTags[t.name][e]=="function"?u.customTags[t.name][e]:function(){}};const lt=(t,e)=>e?typeof t=="string"&&!t.match(/\s/)&&t.length>0?parseInt(t)+"px":t:typeof t=="string"&&t.length>0&&t.match(/^[0-9]{1,8}$/)?t+"px":t,B=t=>{let e=t.split("_");return e.length>1?L.translate([e[0]+" {0}",e[1]]):L.translate(t)};tinymce.tp$HtmlPanelFn=window.tp$HtmlPanelFn=function(t,e,o){f.buttonsStyle&&(f.buttonsStyle[e]=o),document.querySelector("#"+e+"_StyleID").innerHTML=t.nextElementSibling.innerHTML};const it={count:0},rt=t=>{let e=new Date().getTime()+"-"+it.count++,o=`
...
`;return document.querySelector(t.selector).outerHTML=o+document.querySelector(t.selector).outerHTML,e},dt=(t,e,o)=>{let a="";a=f.buttonsStyle&&f.buttonsStyle[e],o||(o=S(t.tp$CustomTags.buttons.styleSheetList)),a||(a=f.buttonsStyle&&(f.buttonsStyle[e]=o[0]));let n="",s="",i="";return o.forEach((l,r)=>{l===a&&(s=`<span class="tp-buttons" data-tp-style="${l}">${B(l)}</span>`),n+=`<li ><input id="${e+"_"+r}" type="radio" name="${e}" ${a===l?" checked ":""}  onclick="tinymce.tp$HtmlPanelFn(this,'${e}','${l}')"> <label for="${e+"_"+r}" > <span class="tp-buttons" data-tp-style="${l}">${B(l)}</span></label></li>
`,i+=w(t.tp$CustomTags.buttons.styleSheetList[l],l)}),`<div style="width: 100%; position: relative; " >
  ...
  .mce-content-body *[contentEditable=false] *[contentEditable=true]:hover {
      outline: none!important;
  }`;t.dom.addStyle(a),t.tp$Style={},t.getTpStyle=s=>"<style>"+t.tp$OutputStyle+" </style>";let n=t.tp$CustomTags||u.customTags;F.each(n,function(s,i){ut(e,o,t,s,i)}),t.parser.addAttributeFilter("data-tp-component",s=>{s.forEach(i=>{let l=i.attr("data-tp-component");n[l]&&v(n[l],"parserFn")(i,l,t)})}),t.serializer.addAttributeFilter("data-mce-tp-component",s=>{s.forEach(i=>{let l=i.attr("data-mce-tp-component");n[l]&&v(n[l],"serializerFn")(i,l,t)})}),t.setContent(t.getContent({source_view:!0}))},V=(t,e,o,a,n)=>{a?(!a.tp$CustomTags&&(a.tp$CustomTags=JSON.parse(JSON.stringify(u.customTags))),n?h(a.tp$CustomTags[t][e],o):a.tp$CustomTags[t][e]=o):n?h(u.customTags[t][e],o):u.customTags[t][e]=o},D={custom_elements:"",setCustomTags:V,createCustomTags:(t,e,o)=>{o?(!o.tp$CustomTags&&(o.tp$CustomTags=JSON.parse(JSON.stringify(u.customTags))),o.tp$CustomTags[t]=e):u.customTags[t]=e},setStyleSheetList:(t,e,o,a)=>{V("buttons","styleSheetList",{[e]:{"tp-buttons":_("tp-buttons",o),"tp-buttons:hover":_("tp-buttons:hover",o),"tp-buttons::before":_("tp-buttons::before",o),"tp-buttons::after":_("tp-buttons::after",o)}},a,!0)},createHtmlPanel:dt};var I={name:"tabs",styleSheet:{selector:"default",styleSheetList:{default:{"tp-tabs":"","tp-tabs_top":"","tp-tabs_label.checked":" ","tp-tabs_main":" ","tp-tab_main.checked":" "}}},styleSheetLoadList:{},styleFn:()=>{},state:{count:0},tpComponentDeleteFn:function(){console.log(this)},tpComponentMonitorCmd:()=>{},tpComponentCmdFn:{tabAdd:(t,e)=>{let o=document.createElement("div");o.setAttribute("contenteditable",!1),o.setAttribute("class","tp-partition tp-tabs_label"),o.setAttribute("data-idx",t.tp$state.count);let a=document.createElement("p");a.setAttribute("class","tp-component_inline"),a.setAttribute("data-idx",t.tp$state.count),a.setAttribute("contenteditable",!0),a.innerHTML=e.title,o.appendChild(a),t.insertBefore(o,t.lastChild);let n=document.createElement("div");n.setAttribute("class","tp-tab_main"),n.setAttribute("style","overflow: hidden; max-height: 0; transition: all 0s"),n.innerHTML=e.content,t.lastChild.appendChild(n),t.tp$state.count++},tabDelete:(t,e)=>{t.children[--t.tp$state.count].remove(),t.lastChild.lastChild.remove()},delete:(t,e)=>{t.remove()},getStyle:(t,e)=>{},setStyle:(t,e)=>{console.log(t.querySelector(".tp-tabs_top")),t.setAttribute("data-top-style",e["tp-tabs_top"]),t.shadowRoot.querySelector(".tp-tabs_top").setAttribute("style",e["tp-tabs_top"])}},template:{innerHTML:`
<div class="tp-tabs">
...
<div class="tp-collapse_mainBox">
    ...
    `},isContentEditable:!0,connectedCallback:()=>{},tpComponentCmdFn:{upData:(t,e)=>{let o=e.style,a=c("padding",o),n=c("border",o),s=c("border-width",o);M(e.editor,t,"tp-collapse_main",(a?"padding: "+a+"!important; ":"")+(n?"border: "+n+"!important;":"")+(s?"border-width: "+s+"!important;":""))}},contentEditableFn:(t,e,o,a)=>{const n=document.createElement("div");if(n.setAttribute("contenteditable",!1),n.setAttribute("class","tp-partition tp-collapse_main"),e&&t.lastChild.setAttribute("contenteditable",!0),t.lastChild.getAttribute("class")==="tp-collapse_main"){let s=t.lastChild.getAttribute("style"),i=c("padding",s),l=c("border",s),r=c("border-width",s);M(a,t,"tp-collapse_main",(i?"padding: "+i+"!important; ":"")+(l?"border: "+l+"!important;":"")+(r?"border-width: "+r+"!important;":""))}n.appendChild(t.lastChild),t.appendChild(n)},isHeaderEditable:!0,headerEditableFn:(t,e,o,a)=>{if(t.firstChild.contenteditable!=="true"){const n=document.createElement("div");for(e&&n.setAttribute("contenteditable",!0),n.setAttribute("slot","header"),n.setAttribute("class","tp-collapse_label"),n.setAttribute("style","min-height: 20px; "+t.getAttribute("data-top-style"));t.firstChild&&t.firstChild.className!=="tp-"+o+"_main";)n.appendChild(t.firstChild);t.insertBefore(n,t.firstChild)}},parserFn:(t,e)=>{t.attr({"data-tp-component":null,"data-mce-tp-component":e}),t.attr("data-id",t.firstChild.attr("id")),t.firstChild.remove(),t.lastChild.attr("class","tp-"+e+"_main"),t.type=1,t.name="tp-"+e},serializerFn:(t,e)=>{t.attr({"data-mce-tp-component":null,"data-tp-component":e,contenteditable:null,class:"tp-"+e}),t.firstChild.type=1,t.firstChild.name="label",t.firstChild.attr({contenteditable:null,for:t.attr("data-id")});let o=t.lastChild.attr("style");t.lastChild.unwrap(),t.lastChild.attr({contenteditable:null,class:"tp-"+e+"_main",style:o});let a=new x("input",1);a.shortEnded=!0,a.attr({id:t.attr("data-id"),type:"checkbox"}),t.insert(a,t.firstChild,!0),t.attr("data-id",null),t.type=1,t.name="div"}};const j=t=>/select$/.test(t),q={forecolor:!0,backcolor:!0,tpLetterspacing:!0,tpIconlists:!0,tpColumns:!0,table:!0},C={title:{file:{zh_CN:"\u6587\u4EF6",en_US:"File"},edit:{zh_CN:"\u7F16\u8F91",en_US:"Edit"},view:{zh_CN:"\u89C6\u56FE",en_US:"View"},insert:{zh_CN:"\u63D2\u5165",en_US:"Insert"},format:{zh_CN:"\u683C\u5F0F",en_US:"Format"},table:{zh_CN:"\u8868\u683C",en_US:"Table"},tools:{zh_CN:"\u5DE5\u5177",en_US:"Tools"},help:{zh_CN:"\u5E2E\u52A9",en_US:"Help"}},items:{code:"tools",spellchecker:"tools",spellcheckerlanguage:"tools",wordcount:"tools",image:"insert",link:"insert",media:"insert",hr:"insert",template:"insert",codesample:"insert",charmap:"insert",inserttable:"table",emoticons:"insert",pagebreak:"insert",nonbreaking:"insert",anchor:"insert",toc:"insert",insertdatetime:"insert",bold:"format",italic:"format",underline:"format",strikethrough:"format",blockquote:"format",subscript:"format",superscript:"format",removeformat:"format",formatselect:"format",fontselect:"format",fontsizes:"format",forecolor:"format",backcolor:"format",fontformats:"format",blockformats:"format",codeformat:"format",align:"format",table:"table",lineheight:"format",help:"help"}},R={file:!0,view:!0,edit:!0},J=t=>{let e=[];return t.split("|").forEach(o=>{let a=o.split(" "),n=[];a.forEach(s=>{s&&n.push({isSelect:j(s),name:s}),s&&C.items[s]&&(R[C.items[s]]=!0)}),n.length>0&&e.push(n)}),e},ht=t=>{let e=[];return t.split("|").forEach(o=>{let a=o.split(" "),n=[];a.forEach(s=>{s&&n.push({isSelect:j(s),name:s})}),e.push(n)}),e},U=()=>`.skt-tox-tinymce{
  ...
  }`,mt=t=>{if(!document.querySelector("style#skt-tox-style")){let r=document.createElement("style");r.type="text/css",r.id="skt-tox-style";try{r.appendChild(document.createTextNode(U()))}catch{r.styleSheet.cssText=U()}document.getElementsByTagName("head")[0].appendChild(r)}let e=[];typeof t.toolbar=="string"?e=J(t.toolbar):Array.isArray(t.toolbar)&&t.toolbar.forEach(r=>{e.push(...J(r))});let o=[];if(t.menubar!==!1)if(typeof t.menubar=="string")o=ht(t.menubar);else for(let r in C.title)R[r]&&o.push(C.title[r][t.language||"en_US"]);let a=t.min_height||t.height||200,n=[],s=a-150;for(let r=0;r<s;r+=50)n.push("1");let i=t.selector?document.querySelector(t.selector).parentNode:t.target.parentNode,l=document.createElement("div");return l.className="skt skt-loading",l.innerHTML=xt({selector:t.selector,toolbar:e,menubar:o,branding:t.branding!==!1,placeholderList:n,height:a}),i.style.position="relative",i.style.minHeight=a+"px",i.append(l),l},gt=t=>{let e="";return t.forEach(o=>{e+='<button  class="skt-tox-mbtn skt-tox-mbtn--select"><span class="skt-tox-mbtn__select-label skeleton">'+o+`</span></button>
`}),e},ft=t=>{let e="";return t.forEach(o=>{e+=`<div class="skt-tox-toolbar__group">
...
`}),e+=`</div>
`}),e},yt=t=>{let e="";return t.forEach(o=>{e+=`<p class="skeleton"></p>
`}),e},xt=t=>`
...
</div>`;u.customTags[I.name]=I,u.customTags[P.name]=P,u.customTags[O.name]=O;let vt=(t,e,o)=>{let a=`
`;for(let n=0;n<o;n++)a+=`.tp-${t} > input:nth-child(${n+1}):checked ~ .tp-${t}_top > .tp-${t}_label:nth-child(${n+1}){${e}}
            ...
            `;return a},kt=(t,e)=>{let o="";return S(t.specialStyle).forEach(a=>{o+=t.specialStyle[a]?`
 `+e[a]+" { "+t.specialStyle[a]+"} ":""}),o},_t=t=>{t.tp$OutputStyle="";let e=2,o="",a="",n="",s="",i={},l={},r={};t.tp$Style&&t.tp$Style.mapping&&(!t.tp$CustomTags&&(t.tp$CustomTags=JSON.parse(JSON.stringify(u.customTags))),S(t.tp$Style.mapping).forEach(y=>{let p=t.tp$Style.mapping[y];p.styleCustomTags==="tabs"&&(i[p.styleTemplate]||(o=t.tp$CustomTags[p.styleCustomTags][p.stylePath][p.styleTemplate],i[p.styleTemplate]=!0),e<p.quantity&&(e=p.quantity)),p.styleCustomTags==="collapse"&&(l[p.styleTemplate]||(n+=t.tp$CustomTags[p.styleCustomTags][p.stylePath][p.styleTemplate],l[p.styleTemplate]=!0),s+=p.specialStyle?kt(p,{"tp-collapse_main":'.tp-collapse > input[id="'+y+'"]:checked + .tp-collapse_label + .tp-collapse_main'}):""),p.styleCustomTags==="buttons"&&!r[p.styleTemplate]&&(a+=w(t.tp$CustomTags[p.styleCustomTags][p.stylePath][p.styleTemplate],p.styleTemplate),r[p.styleTemplate]=!0)}));let g="",b="";o&&(o=o.replace(/.tp-tabs\s*{/g,"div.tp-tabs[data-id] {").replace(/\n.tp-tabs\s/g,`
.tp-tabs[data-id] `)+`.tp-tabs[data-id] > input { display: none;} 
 .tp-tabs .tp-tabs_main .tp-tab_main { overflow: hidden;max-height: 0px;}`,g=o.match(/.tp-tabs_label.checked\s*{\n([\s\S]+)\n}/)[1],b=g?vt("tabs",g,e):""),t.tp$OutputStyle=(a?`@font-face {
...
}`:"")+a+n+s+o+b};const wt={iframeLayout:`
   <style>
