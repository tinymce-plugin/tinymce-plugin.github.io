import{_ as c,o as r,c as o,e as h}from"./index.c248884f.js";import{R as t,E as m,a as u}from"./Editor.143d3919.js";import"./index.79eb138f.js";import"./tpImportword.3f709111.js";const j=JSON.stringify({base_url:"/tinymce",branding:!1,language:"zh_CN",menubar:!1,schema:"html5",plugins:"tp code hr",table_default_attributes:{border:"1"},table_default_styles:{"border-collapse":"collapse",width:"100%"},skeletonScreen:!0,table_header_type:"sectionCells",table_responsive_width:!0,file_picker_types:"file img media",fontsize_formats:"12px 14px 16px 18px 24px 36px 48px 56px 72px"}),d={name:"TinymceVue2",props:{value:{type:[String,Number],default:"dsd"},show:{type:Boolean,default:!1},options:{type:Object,default:{}}},emits:["update:value"],data(){return{tinymceID:"tinymce-"+new Date().getTime()+Math.floor(Math.random()*10)+Math.floor(Math.random()*10),tinymceTimerID:null,tinymce_width:"100%",tinymce_height:400,tinymce_loading:"loading",editorFn:""}},methods:{importantFn(){this.editor.execCommand("mceImportword")},xhrOnProgress(a){return this.xhrOnProgress.onprogress=a,function(){var s=this.createXHR();return typeof xhrOnProgress.onprogress!="function"||xhrOnProgress.onprogress&&s.upload&&(s.upload.onprogress=xhrOnProgress.onprogress),s}},createXHR(){return window.XMLHttpRequest?new XMLHttpRequest:window.ActiveXobiect?new ActiveXobiect("Microsoft.XMLHTTP"):""},init(){let a=this,s=JSON.parse(j);s.selector="#"+a.tinymceID,s.setup=n=>{a.editorFn=n,n.on("init",()=>{setTimeout(()=>{a.tinymce_loading=""},200),n.setTpContent(a.value),tinymce.activeEditor.setProgressState(!1,50)}),n.on("input NodeChange",()=>{a.$emit("input",n.getTpContent())})},Object.assign(s,this.options||{}),a.tinymce_height=s.min_height,tinymce.init(s)}}};function g(a,s,n,p,v,y){return r(),o("div",null," five ")}var i=c(d,[["render",g],["__scopeId","data-v-c5dacd42"]]);const e={};e.methods={source(){return`<pre class="hljs fv-hljs"><ul class="highlight-line-number" ><li>1</li><li>2</li><li>3</li><li>4</li><li>5</li><li>6</li><li>7</li><li>8</li><li>9</li><li>10</li><li>11</li><li>12</li><li>13</li><li>14</li><li>15</li><li>16</li><li>17</li><li>18</li><li>19</li><li>20</li><li>21</li><li>22</li><li>23</li><li>24</li><li>25</li><li>26</li><li>27</li><li>28</li><li>29</li><li>30</li><li>31</li><li>32</li><li>33</li><li>34</li><li>35</li><li>36</li><li>37</li><li>38</li><li>39</li><li>40</li><li>41</li><li>42</li></ul><code class=" hljs hljs-html" @click.stop="()=>{}"><span class="hljs-tag">&lt;<span class="hljs-name">div</span>&gt;</span>
...
</code><div class="language-text" >html</div></pre>`},sourceCode(a){class s extends t.Component{constructor(p){super(p),this.reactDemoInit={min_height:200,base_url:"/tinymce",branding:!1,language:"zh_CN",menubar:!1,plugins:["advlist autolink lists link image charmap print tpImportword preview anchor","searchreplace visualblocks code fullscreen indent2em autoresize tpCollapse tpTabs tpButtons","insertdatetime media table paste code help wordcount"],toolbar:"undo redo indent2em autoresize tpCollapse tpTabs tpButtons | formatselect image tpImportword | bold italic backcolor | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | removeformat | help",content_style:"body { font-family:Helvetica,Arial,sans-serif; font-size:14px }",skeletonScreen:!0},this.reactDemoInitialValue="<p>\u8FD9\u662F\u4E00\u4E2AREactDemo</p>"}render(){return t.createElement("div",null,t.createElement("div",null,""),t.createElement(m,{initialValue:this.reactDemoInitialValue,init:this.reactDemoInit}))}}return u.render(t.createElement(s,null),a)}};e.template=`<PreviewReact class="demo-quickStart" idx="Demo0"  :source="source()">
                              <template v-slot:description><p>test</p>
</template>
...
</code><div class="language-text" >vue</div></pre>`}};l.template=`<PreviewVue2 class="demo-quickStart"  :template="template()"  :source="source()">
                              <template v-slot:description><p>sdsVuwDFSDF</p>
</template>
                            </PreviewVue2>`;const w=h({components:{Demo0:e,Demo1:l},template:`<div class="fv-mardown-html"><div class="fv-mardown-main"><h2 id="\u5FEB\u901F\u4E0A\u624B" tabindex="-1"><a class="header-anchor" href="#\u5FEB\u901F\u4E0A\u624B">#</a> \u5FEB\u901F\u4E0A\u624B</h2>
<p class="language-html"><Demo0  data-isComponent="react" /></p>
<p class="language-vue"><Demo1 data-isComponent="vue" /></p>
</div></div><PagesRouter  docPath="guide/quickStart.md" mapType="docs" docRepo="tinymce-plugin-docs" pagesName="quickStart" />`});export{w as default};
