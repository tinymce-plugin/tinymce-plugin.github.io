...
</code><div class="language-text" >vue</div></pre>`}};n.template=`<Preview class="demo-tpIndent2em_t_x4x5qb1667831245362_p_" :source="source()">
...
</code><div class="language-text" >vue</div></pre>`}};a.template=`<PreviewVue2 class="demo-tpIndent2em_t_x4x5qb1667831245362_p_"  :template="template()"  :source="source()">
...
</code><div class="language-text" >html</div></pre>`},sourceCode(i){class e extends s.Component{constructor(c){super(c),this.state={reactDemoInitialValue:"<p>\u8FD9\u662F\u4E00\u4E2AREactDemo</p>"},this.reactDemoInit={min_height:220,base_url:"/tinymce",branding:!1,language:"zh_CN",menubar:!1,skeletonScreen:!0,plugins:"code tpIndent2em autoresize",toolbar:"undo redo code tpIndent2em",content_style:"body { font-family:Helvetica,Arial,sans-serif; font-size:14px }"},this.handleChange=h=>{this.setState({reactDemoInitialValue:h})}}render(){return s.createElement("div",null,s.createElement("h1",null,"\u8FD9\u662F\u4E00\u4E2A\u9996\u884C\u7F29\u8FDB\u63D2\u4EF6"),s.createElement("div",null,s.createElement(r,{initialValue:this.state.reactDemoInitialValue,init:this.reactDemoInit,onEditorChange:this.handleChange})),s.createElement("div",{dangerouslySetInnerHTML:{__html:this.state.reactDemoInitialValue}}))}}return o.render(s.createElement(e,null),i)}};t.template=`<PreviewReact class="demo-tpIndent2em_t_x4x5qb1667831245362_p_" idx="Demo3"  :source="source()">
...
<Demo1 data-isComponent="vue" class="demo-tpIndent2em_t_x4x5qb1667831245362_p_" />
 </demoGroupItem>
 <demoGroupItem title="Vue2">
<Demo2 data-isComponent="vue" class="demo-tpIndent2em_t_x4x5qb1667831245362_p_" />
 </demoGroupItem>
 <demoGroupItem title="React">
<Demo3  data-isComponent="react"  class="demo-tpIndent2em_t_x4x5qb1667831245362_p_" />
 </demoGroupItem>
</demoGroup></div></div><PagesRouter  docPath="__docs__/tpIndent2em.md" mapType="docs" docRepo="tp-indent2em" pagesName="tpIndent2em_t_x4x5qb1667831245362_p_" />`});export{b as default};
