var At=(F,d)=>()=>(d||F((d={exports:{}}).exports,d),d.exports);var Et=At((Mt,E)=>{/*! 
...
*/(function(F){let d=tinymce,T=d.util.Tools,y=d.html.Node;d.html.Schema;let H=d.util.XHR,_=d.util.I18n,G=new d.html.Serializer().serialize,Y=new d.html.DomParser().parse,g={};window.tp$State=g;let c=(t,a)=>{let n=a?a.match(new RegExp(t+':(.+?)"?[;}]')):"";return n?n[1]:!1};function M(t,a,n,e){t.tp$Style.mapping&&t.tp$Style.mapping[""+a.getAttribute("data-id")]&&(t.tp$Style.mapping[""+a.getAttribute("data-id")].specialStyle[""+n]=e)}let u={customTags:{}},S=Object.keys,h=function(){return h=Object.assign||function(a){for(var n,e=1,l=arguments.length;e<l;e++){n=arguments[e];for(var s in n)Object.prototype.hasOwnProperty.call(n,s)&&(a[s]=n[s])}return a},h.apply(this,arguments)},Z=Object.hasOwnProperty;var Q=function(t){return t==null},K=function(t){return!Q(t)};const v=t=>{if(typeof t=="object")return JSON.stringify(t).replace(/"([-A-Za-z]+?)":""[,}]/g,"").replace(/,/gi,";").replace(/{/gi,"").replace(/}/gi,"").replace(/"/gi,"")},L=t=>typeof t=="string"&&t!=="{}"?(t=JSON.stringify(t),JSON.parse(("{"+t.replace(/:/g,'": "').replace(/;\s*/g,'","')+"}").replace(/,\"\"\}$/,"}"))):t,k=(t,a)=>{const n=a.match(new RegExp(`.${t}\\s*\\{([\\s\\S]+)\\}`));return n&&n[1]?n[1].replace(/\}([\s\S]+)/,"").trim():""};var tt=function(t,a){return Z.call(t,a)},et=function(t,a,n,e){e===void 0&&(e=null);var l=t.attr(n);return K(l)?l:tt(a,n)?null:e};const z=t=>t.replace(/[-|\_](\w)/g,function(a,n){return n.toUpperCase()}),at=t=>t.replace(/([A-Z])/g,"_$1").toLowerCase().replace(/\-/g,"_"),nt=t=>t.replace(/([A-Z])/g,"-$1").toLowerCase().replace(/\_/g,"-");var lt=function(t,a){let n="";if(!t)return"";for(a=z(a);t.nodeName!=="P"&&t.nodeName!=="LI"&&t.nodeName!=="DIV"&&t.nodeName!=="BODY";){if(t.style[a]){n=t.style[a];break}t=t.parentNode}return n};let w=(t,a)=>{let n="";return n+=t["tp-buttons"]?'.tp-buttons[data-tp-style="'+a+'"] {'+t["tp-buttons"]+`}
...
`:"",n};const st=(t,a,n)=>{!n&&(n=a*100);let e={id:null,outTime:n,outId:null};e.id=setInterval(l=>{t(()=>{clearTimeout(l.outId),clearInterval(l.id)})},a,e),e.outId=setTimeout(()=>{e.id&&clearInterval(e.id)},e.outTime)};let x=function(t,a){return typeof t[a]=="function"?t[a]:typeof u.customTags[t.name][a]=="function"?u.customTags[t.name][a]:function(){}};const ot=(t,a)=>a?typeof t=="string"&&!t.match(/\s/)&&t.length>0?parseInt(t)+"px":t:typeof t=="string"&&t.length>0&&t.match(/^[0-9]{1,8}$/)?t+"px":t,B=t=>{let a=t.split("_");return a.length>1?_.translate([a[0]+" {0}",a[1]]):_.translate(t)};tinymce.tp$HtmlPanelFn=window.tp$HtmlPanelFn=function(t,a,n){g.buttonsStyle&&(g.buttonsStyle[a]=n),document.querySelector("#"+a+"_StyleID").innerHTML=t.nextElementSibling.innerHTML};const it={count:0},rt=t=>{let a=new Date().getTime()+"-"+it.count++,n=`
...
`;return document.querySelector(t.selector).outerHTML=n+document.querySelector(t.selector).outerHTML,a},pt=(t,a,n)=>{let e="";e=g.buttonsStyle&&g.buttonsStyle[a],n||(n=S(t.tp$CustomTags.buttons.styleSheetList)),e||(e=g.buttonsStyle&&(g.buttonsStyle[a]=n[0]));let l="",s="",o="";return n.forEach((i,r)=>{i===e&&(s=`<span class="tp-buttons" data-tp-style="${i}">${B(i)}</span>`),l+=`<li ><input id="${a+"_"+r}" type="radio" name="${a}" ${e===i?" checked ":""}  onclick="tinymce.tp$HtmlPanelFn(this,'${a}','${i}')"> <label for="${a+"_"+r}" > <span class="tp-buttons" data-tp-style="${i}">${B(i)}</span></label></li>
`,o+=w(t.tp$CustomTags.buttons.styleSheetList[i],i)}),`<div style="width: 100%; position: relative; " >
  ...
  :host {
      overflow: hidden;
      display: block; 
  }`,s.innerHTML=e.template.innerHTML;class r extends t.HTMLElement{constructor(){super(),this.setAttribute("contenteditable",!1),this.setAttribute("data-mce-tp-component",l),this.attachShadow({mode:"open"}),this.tp$state=typeof e.state=="object"?JSON.parse(JSON.stringify(e.state)):{},A(n,this,"init",e),this.tpComponentDelete=typeof e.tpComponentDelete=="function"?e.tpComponentDelete.bind(this):()=>{this.remove()},this.tpComponentCmd=typeof e.tpComponentCmdFn=="object"?JSON.stringify(e.tpComponentCmdFn)!=="{}"?(b,f)=>{e.tpComponentCmdFn[b](this,f),A(n,this,b,e)}:(b,f)=>{u.customTags[l].tpComponentCmdFn[b](this,f),A(n,this,b,e)}:()=>{console.log("\u65E0\u53EF\u7528cmd")},i.id="tpComponentStyle_"+this.getAttribute("data-id"),l=="tabs"&&(i.textContent=e.styleSheetLoadList&&e.styleSheetLoadList[this.getAttribute("data-tp-style")||"default"]?e.styleSheetLoadList[this.getAttribute("data-tp-style")||"default"].replace(/.tp-tabs\s*\{/g,":host   {").replace(/.tp-tabs_label\b\s/g,"::slotted(.tp-tabs_label)   ").replace(/.tp-tabs_label:hover\b\s/g,"::slotted(.tp-tabs_label:hover)   ").replace(/.tp-tabs_label.checked\b\s/g,"::slotted(.tp-tabs_label.checked)   "):""),l=="collapse"&&(i.textContent=e.styleSheetLoadList&&e.styleSheetLoadList[this.getAttribute("data-tp-style")||"default"]?e.styleSheetLoadList[this.getAttribute("data-tp-style")||"default"].replace(/>/g," ").replace(/.tp-collapse\s*\{/g,":host   {").replace(/label.tp-collapse_label\b\s/g,"::slotted(.tp-collapse_label)   ").replace(/label.tp-collapse_label::/g,"::slotted(.tp-collapse_label)::").replace(/.tp-tabs_label:hover\b\s/g,"::slotted(.tp-tabs_label:hover)   ").replace(/.tp-tabs_label.checked\b\s/g,"::slotted(.tp-tabs_label.checked)   "):""),l=="buttons"&&(i.textContent=e.styleSheetList&&e.styleSheetList[this.getAttribute("data-tp-style")||"default"]?w(e.styleSheetList[this.getAttribute("data-tp-style")||"default"],this.getAttribute("data-tp-style")||"default").replace(/\[data-tp-style=(.*?)\]/g,"").replace(/>/g," ").replace(/.tp-buttons\s*\{/g,":host   {").replace(/.tp-buttons:hover\s*\{/g,":host(:hover)   {").replace(/.tp-buttons::before\s*\{/g,":host(.tp-buttons)::before   {").replace(/.tp-buttons::after\s*\{/g,":host(.tp-buttons)::after   {"):""),s.content.prepend(i),s.content.prepend(o),this.shadowRoot.appendChild(s.content.cloneNode(!0))}connectedCallback(){x(e,"headerEditableFn")(this,e.isHeaderEditable,l,n),x(e,"contentEditableFn")(this,e.isContentEditable,l,n),x(e,"connectedCallback")(this.shadowRoot,this)}static get observedAttributes(){return["data-top-bg","data-mce-tp-component","data-value"]}static tp$Delete(){console.log(this)}}try{t.customElements.define("tp-"+l,r)}catch{}},bt=t=>{const a=t.getWin(),n=t.getDoc();let e=t.baseURI.source;H.send({url:e+"/plugins/tpIconlists/tpIconlists.css",async:!1,dataType:"text",success:function(o){t.dom.addStyle(o)}}),H.send({url:e+"/css/iconfont.css",async:!1,dataType:"text",success:function(o){t.dom.addStyle(o)}}),ct(t),dt(t);const l=`.mce-content-body [data-mce-tp-component][contenteditable=false][data-mce-selected] {
      outline: none;
      cursor: default;
  ...
  .mce-content-body *[contentEditable=false] *[contentEditable=true]:hover {
      outline: none!important;
  }`;t.dom.addStyle(l),t.tp$Style={},t.getTpStyle=o=>"<style>"+t.tp$OutputStyle+" </style>";let s=t.tp$CustomTags||u.customTags;T.each(s,function(o,i){ut(a,n,t,o,i)}),t.parser.addAttributeFilter("data-tp-component",o=>{o&&o.forEach(i=>{let r=i.attr("data-tp-component");s[r]&&x(s[r],"parserFn")(i,r,t)})}),t.serializer.addAttributeFilter("data-mce-tp-component",o=>{o&&o.forEach(i=>{let r=i.attr("data-mce-tp-component");s[r]&&x(s[r],"serializerFn")(i,r,t)})}),t.setContent(t.getContent({source_view:!0}))},D=(t,a,n,e,l)=>{e?(!e.tp$CustomTags&&(e.tp$CustomTags=JSON.parse(JSON.stringify(u.customTags))),l?h(e.tp$CustomTags[t][a],n):e.tp$CustomTags[t][a]=n):l?h(u.customTags[t][a],n):u.customTags[t][a]=n},P={custom_elements:"",setCustomTags:D,createCustomTags:(t,a,n)=>{n?(!n.tp$CustomTags&&(n.tp$CustomTags=JSON.parse(JSON.stringify(u.customTags))),n.tp$CustomTags[t]=a):u.customTags[t]=a},setStyleSheetList:(t,a,n,e)=>{D("buttons","styleSheetList",{[a]:{"tp-buttons":k("tp-buttons",n),"tp-buttons:hover":k("tp-buttons:hover",n),"tp-buttons::before":k("tp-buttons::before",n),"tp-buttons::after":k("tp-buttons::after",n)}},e,!0)},createHtmlPanel:pt};var N={name:"tabs",styleSheet:{selector:"default",styleSheetList:{default:{"tp-tabs":"","tp-tabs_top":"","tp-tabs_label.checked":" ","tp-tabs_main":" ","tp-tab_main.checked":" "}}},styleSheetLoadList:{},styleFn:()=>{},state:{count:0},tpComponentDeleteFn:function(){console.log(this)},tpComponentMonitorCmd:()=>{},tpComponentCmdFn:{tabAdd:(t,a)=>{let n=document.createElement("div");n.setAttribute("contenteditable",!1),n.setAttribute("class","tp-partition tp-tabs_label"),n.setAttribute("data-idx",t.tp$state.count);let e=document.createElement("p");e.setAttribute("class","tp-component_inline"),e.setAttribute("data-idx",t.tp$state.count),e.setAttribute("contenteditable",!0),e.innerHTML=a.title,n.appendChild(e),t.insertBefore(n,t.lastChild);let l=document.createElement("div");l.setAttribute("class","tp-tab_main"),l.setAttribute("style","overflow: hidden; max-height: 0; transition: all 0s"),l.innerHTML=a.content,t.lastChild.appendChild(l),t.tp$state.count++},tabDelete:(t,a)=>{t.children[--t.tp$state.count].remove(),t.lastChild.lastChild.remove()},delete:(t,a)=>{t.remove()},getStyle:(t,a)=>{},setStyle:(t,a)=>{console.log(t.querySelector(".tp-tabs_top")),t.setAttribute("data-top-style",a["tp-tabs_top"]),t.shadowRoot.querySelector(".tp-tabs_top").setAttribute("style",a["tp-tabs_top"])}},template:{innerHTML:`
<div class="tp-tabs">
...
<div class="tp-collapse_mainBox">
    ...
    `},isContentEditable:!0,connectedCallback:()=>{},tpComponentCmdFn:{upData:(t,a)=>{let n=a.style,e=c("padding",n),l=c("border",n),s=c("border-width",n);M(a.editor,t,"tp-collapse_main",(e?"padding: "+e+"!important; ":"")+(l?"border: "+l+"!important;":"")+(s?"border-width: "+s+"!important;":""))}},contentEditableFn:(t,a,n,e)=>{const l=document.createElement("div");if(l.setAttribute("contenteditable",!1),l.setAttribute("class","tp-partition tp-collapse_main"),a&&t.lastChild.setAttribute("contenteditable",!0),t.lastChild.getAttribute("class")==="tp-collapse_main"){let s=t.lastChild.getAttribute("style"),o=c("padding",s),i=c("border",s),r=c("border-width",s);M(e,t,"tp-collapse_main",(o?"padding: "+o+"!important; ":"")+(i?"border: "+i+"!important;":"")+(r?"border-width: "+r+"!important;":""))}l.appendChild(t.lastChild),t.appendChild(l)},isHeaderEditable:!0,headerEditableFn:(t,a,n,e)=>{if(t.firstChild.contenteditable!=="true"){const l=document.createElement("div");for(a&&l.setAttribute("contenteditable",!0),l.setAttribute("slot","header"),l.setAttribute("class","tp-collapse_label"),l.setAttribute("style","min-height: 20px; "+t.getAttribute("data-top-style"));t.firstChild&&t.firstChild.className!=="tp-"+n+"_main";)l.appendChild(t.firstChild);t.insertBefore(l,t.firstChild)}},parserFn:(t,a)=>{t.attr({"data-tp-component":null,"data-mce-tp-component":a}),t.attr("data-id",t.firstChild.attr("id")),t.firstChild.remove(),t.lastChild.attr("class","tp-"+a+"_main"),t.type=1,t.name="tp-"+a},serializerFn:(t,a)=>{t.attr({"data-mce-tp-component":null,"data-tp-component":a,contenteditable:null,class:"tp-"+a}),t.firstChild.type=1,t.firstChild.name="label",t.firstChild.attr({contenteditable:null,for:t.attr("data-id")});let n=t.lastChild.attr("style");t.lastChild.unwrap(),t.lastChild.attr({contenteditable:null,class:"tp-"+a+"_main",style:n});let e=new y("input",1);e.shortEnded=!0,e.attr({id:t.attr("data-id"),type:"checkbox"}),t.insert(e,t.firstChild,!0),t.attr("data-id",null),t.type=1,t.name="div"}};const R=t=>/select$/.test(t),q={forecolor:!0,backcolor:!0,tpLetterspacing:!0,tpIconlists:!0,tpColumns:!0,table:!0},C={title:{file:{zh_CN:"\u6587\u4EF6",en_US:"File"},edit:{zh_CN:"\u7F16\u8F91",en_US:"Edit"},view:{zh_CN:"\u89C6\u56FE",en_US:"View"},insert:{zh_CN:"\u63D2\u5165",en_US:"Insert"},format:{zh_CN:"\u683C\u5F0F",en_US:"Format"},table:{zh_CN:"\u8868\u683C",en_US:"Table"},tools:{zh_CN:"\u5DE5\u5177",en_US:"Tools"},help:{zh_CN:"\u5E2E\u52A9",en_US:"Help"}},items:{code:"tools",spellchecker:"tools",spellcheckerlanguage:"tools",wordcount:"tools",image:"insert",link:"insert",media:"insert",hr:"insert",template:"insert",codesample:"insert",charmap:"insert",inserttable:"table",emoticons:"insert",pagebreak:"insert",nonbreaking:"insert",anchor:"insert",toc:"insert",insertdatetime:"insert",bold:"format",italic:"format",underline:"format",strikethrough:"format",blockquote:"format",subscript:"format",superscript:"format",removeformat:"format",formatselect:"format",fontselect:"format",fontsizes:"format",forecolor:"format",backcolor:"format",fontformats:"format",blockformats:"format",codeformat:"format",align:"format",table:"table",lineheight:"format",help:"help"}},W={file:!0,view:!0,edit:!0},U=t=>{let a=[];return t.split("|").forEach(e=>{let l=e.split(" "),s=[];l.forEach(o=>{o&&s.push({isSelect:R(o),name:o}),o&&C.items[o]&&(W[C.items[o]]=!0)}),s.length>0&&a.push(s)}),a},ht=t=>{let a=[];return t.split("|").forEach(e=>{let l=e.split(" "),s=[];l.forEach(o=>{o&&s.push({isSelect:R(o),name:o})}),a.push(s)}),a},J=()=>`.skt-tox-tinymce{
  ...
  }`,mt=t=>{if(!document.querySelector("style#skt-tox-style")){let r=document.createElement("style");r.type="text/css",r.id="skt-tox-style";try{r.appendChild(document.createTextNode(J()))}catch{r.styleSheet.cssText=J()}document.getElementsByTagName("head")[0].appendChild(r)}let a=[];typeof t.toolbar=="string"?a=U(t.toolbar):Array.isArray(t.toolbar)&&t.toolbar.forEach(r=>{a.push(...U(r))});let n=[];if(t.menubar!==!1)if(typeof t.menubar=="string")n=ht(t.menubar);else for(let r in C.title)W[r]&&n.push(C.title[r][t.language||"en_US"]);let e=t.min_height||t.height||200,l=[],s=e-150;for(let r=0;r<s;r+=50)l.push("1");let o=t.selector?document.querySelector(t.selector).parentNode:t.target.parentNode,i=document.createElement("div");return i.className="skt skt-loading",i.innerHTML=xt({selector:t.selector,toolbar:a,menubar:n,branding:t.branding!==!1,placeholderList:l,height:e}),o.style.position="relative",o.style.minHeight=e+"px",o.append(i),i},gt=t=>{let a="";return t.forEach(n=>{a+='<button  class="skt-tox-mbtn skt-tox-mbtn--select"><span class="skt-tox-mbtn__select-label skeleton">'+n+`</span></button>
`}),a},ft=t=>{let a="";return t.forEach(n=>{a+=`<div class="skt-tox-toolbar__group">
`,n.forEach(e=>{a+='<button class="skt-tox-tbtn '+(e.isSelect?" skt-tox-tbtn--select":"")+(q[e.name]?" skt-tox-split-button":"")+'"><span class="'+(e.isSelect?"skt-tox-tbtn__select-label skt-tox-tbtn--select":"skt-tox-icon tox-tbtn__icon-wrap")+' skeleton">'+e.name+"</span>"+(e.isSelect||q[e.name]?'<div class="skt-tox-tbtn__select-chevron skeleton"></div>':"")+`</button>
`}),a+=`</div>
...
</div>`;u.customTags[N.name]=N,u.customTags[I.name]=I,u.customTags[O.name]=O;let vt=(t,a,n)=>{let e=`
...
}`:"")+e+l+s+n+b};const Ct={iframeLayout:`
   <style>
