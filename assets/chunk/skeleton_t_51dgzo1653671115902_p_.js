...
</code><div class="language-text" >html</div></pre>`},sourceCode(){return'<iframe scrolling="no" style="width:100%;margin:auto 0;border:0px; min-height: 519px"  onload="autoIframeHeight(this)"  src="/demo/demo-skeleton_t_51dgzo1653671115902_p_1653671119924/index.html"></iframe>'}};s.template=`<PreviewIframe class="demo-skeleton_t_51dgzo1653671115902_p_" idx="Demo0"  :source="source()" :sourceCode="sourceCode()">
                              
                            </PreviewIframe>`;const p=a({components:{Demo0:s},template:`<div class="fv-mardown-html"><div class="fv-mardown-main"><h1 id="\u5F00\u542F\u9AA8\u67B6\u5C4F\uFF08skeletonScreen\uFF09" tabindex="-1"><a class="header-anchor" href="#\u5F00\u542F\u9AA8\u67B6\u5C4F\uFF08skeletonScreen\uFF09">#</a> \u5F00\u542F\u9AA8\u67B6\u5C4F\uFF08skeletonScreen\uFF09</h1>
...
<hr>
<h2 id="title:\u57FA\u7840\u6837\u4F8Bsort:99" tabindex="-1"><a class="header-anchor" href="#title: \u57FA\u7840\u6837\u4F8Bsort: 99">#</a> title: \u57FA\u7840\u6837\u4F8B
sort: 99</h2>
<p class="language-html"><Demo0  data-isComponent="iframe" /></p>
</div></div><PagesRouter  docPath="guide/skill/skeleton.md" mapType="docs" docRepo="tinymce-plugin-docs" pagesName="skeleton_t_51dgzo1653671115902_p_" />`});export{p as default};
