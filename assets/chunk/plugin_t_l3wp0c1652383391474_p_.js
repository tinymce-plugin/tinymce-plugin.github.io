...
</code><div class="language-text" >html</div></pre>`},sourceCode(){return'<iframe scrolling="no" style="width:100%;margin:auto 0;border:0px; min-height: 519px"  onload="autoIframeHeight(this)"  src="/demo/demo-plugin_t_l3wp0c1652383391474_p_1652383397066/index.html"></iframe>'}};s.template=`<PreviewIframe class="demo-plugin_t_l3wp0c1652383391474_p_" idx="Demo0"  :source="source()" :sourceCode="sourceCode()">
...
</div></div><PagesRouter  docPath="guide/contributing/plugin.md" mapType="docs" docRepo="tinymce-plugin-docs" pagesName="plugin_t_l3wp0c1652383391474_p_" />`});export{p as default};
