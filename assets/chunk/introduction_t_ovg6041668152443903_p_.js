import"./pinia.js";import"./tinymce.js";import{E as _}from"./Editor.js";import"./plugin.js";import"./plugin2.js";import"./plugin3.js";import{M as k}from"./vue.js";/*! 
...
*/(function(){var m=function(s){return s.getParam("tp_lineheight_value","1 1.5 1.6 1.75 1.8 2 3 4 5")},e=function(s,a){s.undoManager.transact(function(){s.focus(),s.execCommand("tpLineHeight",!1,a)})},f=function(s,a){s.ui.registry.getAll().icons[a.registryName]||s.ui.registry.addIcon(a.registryName,a.icon);var r=tinymce.util.Tools.resolve("tinymce.util.Tools"),h=s.tp$.Tools,b=function(p){return p.length>0?p[0]:""},g=m(s).split(" "),c=h.selection.cell(b(g));s.ui.registry.addSplitButton(a.registryName,{icon:a.registryName,tooltip:a.title,select:function(p){return p===c.get()},fetch:function(p){var n=s.dom,l=s.selection.getSelectedBlocks(),t=-1;t==-1&&(t=n.getStyle(l,"line-height")?n.getStyle(l,"line-height"):""),p(r.map(g,function(i){return t==i&&c.set(i),{type:"choiceitem",text:i,value:i}}))},onAction:function(){e(s,c.getAction())},onItemAction:function(p,n){c.set(n,n),e(s,n)}}),s.ui.registry.addNestedMenuItem(a.registryName,{text:a.title,icon:a.registryName,getSubmenuItems:function(){var p=s.dom,n=s.selection.getSelectedBlocks(),l=-1;return l==-1&&(l=p.getStyle(n,"line-height")?p.getStyle(n,"line-height"):""),r.map(g,function(t){return{type:"togglemenuitem",text:t,active:l===t,onAction:function(){c.set(t,t),e(s,t)}}})}})},o=function(s,a){s.addCommand("mce".concat(a.registryName.substring(0,1).toUpperCase()+a.registryName.substring(1)),function(r,h){e(s,h)})},j=function(s){tinymce.PluginManager.add(s.registryName,function(a,r){return f(a,s),o(a,s),{getMetadata:function(){return{name:s.name,url:s.repo}}}})},d={name:"Lineheight",registryName:"tpLineheight",title:"Line Height",repo:"https://github.com/tinymce-plugin/tp-lineheight",icon:'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M9.984 12.984v-1.969h12v1.969h-12zM9.984 18.984v-1.969h12v1.969h-12zM9.984 5.016h12v1.969h-12v-1.969zM6 6.984v10.031h2.484l-3.469 3.469-3.516-3.469h2.484v-10.031h-2.484l3.516-3.469 3.469 3.469h-2.484z"></path></svg>'};j(d);var v={opt:d};return v})();/*! 
...
*/(function(){var m=function(s){return s.getParam("tp-letterspacing","0px 1px 2px 4px 6px 8px 10px 20px 40px")},e=function(s,a){s.undoManager.transact(function(){s.focus(),s.execCommand("tpLetterspacing",!1,a)})},f=function(s,a){s.ui.registry.getAll().icons[a.registryName]||s.ui.registry.addIcon(a.registryName,a.icon);var r=tinymce.util.Tools.resolve("tinymce.util.Tools"),h=s.tp$.Tools,b=function(n){var l=n,t=n,i=function(){return l},u=function(){return t},q=function(x,w){l=x,w&&(t=w)};return{get:i,set:q,getAction:u}},g=function(n){return n.length>0?n[0]:""},c=m(s).split(" "),p=b(g(c));s.ui.registry.addSplitButton(a.registryName,{icon:a.registryName,tooltip:a.title,select:function(n){return n===p.get()},fetch:function(n){var l=s.selection.getStart(),t=-1;if(t==-1){var i=h.getCurrentValue(l,"letter-spacing");t=i||g(c)}n(r.map(c,function(u){return t==u&&p.set(u),{type:"choiceitem",text:u,value:u}}))},onAction:function(){e(s,p.getAction())},onItemAction:function(n,l){p.set(l,l),e(s,l)}}),s.ui.registry.addNestedMenuItem(a.registryName,{text:a.title,icon:a.registryName,getSubmenuItems:function(){var n=s.selection.getStart(),l=-1;if(l==-1){var t=h.getCurrentValue(n,"letter-spacing");l=t||g(c)}return r.map(c,function(i){return{type:"togglemenuitem",text:i,active:l===i,onAction:function(){p.set(i,i),e(s,i)}}})}})},o=function(s,a){s.addCommand("mce".concat(a.registryName.substring(0,1).toUpperCase()+a.registryName.substring(1)),function(r,h){e(s,h)})},j=function(s){tinymce.PluginManager.add(s.registryName,function(a,r){return f(a,s),o(a,s),{getMetadata:function(){return{name:s.name,url:s.repo}}}})},d={name:"Letterspacing",registryName:"tpLetterspacing",title:"Letter Spacing",repo:"https://github.com/tinymce-plugin/tp-letterspacing",icon:'<svg t="1610616201691" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="969" width="24" height="24"><path d="M682.666667 704l128 106.666667-128 106.666666v-85.333333H341.333333v85.333333L213.333333 810.666667l128-106.666667v85.333333h341.333334v-85.333333zM170.666667 170.666667v682.666666H85.333333V170.666667h85.333334z m768 0v682.666666h-85.333334V170.666667h85.333334z m-394.666667 0l202.666667 469.333333h-89.6l-38.4-93.866667h-213.333334L366.933333 640H277.333333l202.666667-469.333333h64zM512 255.146667L432.213333 469.333333h159.573334L512 255.146667z" p-id="970" fill="#222f3e"></path></svg>'};j(d);var v={opt:d};return v})();const y={name:"domeVue3",components:{TinymceVue:_},data(){return{content:"\u6B22\u8FCE\u6765\u5230 Tinymce-plugin",tinymceOptions:{min_height:200,max_height:700,skeletonScreen:!0,menubar:!1,base_url:"/tinymce",plugins:"tp code  tpIndent2em autoresize tpCollapse tpTabs tpButtons tpLineheight tpLetterspacing tpImportword tpLogicflow preview",toolbar:["|code tpIndent2em tpCollapse tpTabs tpButtons  tpLayout tpLineheight tpLetterspacing tpImportword tpLogicflow | Preview"],images_upload_handler:function(m,e,f){var o=m.blob();o.name||(o.name="vue-"+Date.now()+Math.floor(Math.random()*1e3)+".png");var j=window.URL||window.webkitURL||window;e(j.createObjectURL(o))}}}}};y.methods?y.methods.source=function(){return`<pre class="hljs fv-hljs "><ul class="highlight-line-number "  ><li ><span>1</span></li><li ><span>2</span></li><li ><span>3</span></li><li ><span>4</span></li><li ><span>5</span></li><li ><span>6</span></li><li ><span>7</span></li><li ><span>8</span></li><li ><span>9</span></li><li ><span>10</span></li><li ><span>11</span></li><li ><span>12</span></li><li ><span>13</span></li><li ><span>14</span></li><li ><span>15</span></li><li ><span>16</span></li><li ><span>17</span></li><li ><span>18</span></li><li ><span>19</span></li><li ><span>20</span></li><li ><span>21</span></li><li ><span>22</span></li><li ><span>23</span></li><li ><span>24</span></li><li ><span>25</span></li><li ><span>26</span></li><li ><span>27</span></li><li ><span>28</span></li><li ><span>29</span></li><li ><span>30</span></li><li ><span>31</span></li><li ><span>32</span></li><li ><span>33</span></li><li ><span>34</span></li><li ><span>35</span></li><li ><span>36</span></li><li ><span>37</span></li><li ><span>38</span></li><li ><span>39</span></li><li ><span>40</span></li><li ><span>41</span></li><li ><span>42</span></li><li ><span>43</span></li><li ><span>44</span></li><li ><span>45</span></li><li ><span>46</span></li></ul><code class=" hljs  hljs-js" @click.stop="()=>{}">&lt;template&gt;
...
<span class="hljs-keyword">import</span> <span class="hljs-string">&quot;tinymce-plugin/plugins/tpLayout/plugin.js&quot;</span>;
<span class="hljs-keyword">import</span> <span class="hljs-string">&quot;tinymce-plugin/plugins/tpLineheight/plugin.js&quot;</span>;
<span class="hljs-keyword">import</span> <span class="hljs-string">&quot;tinymce-plugin/plugins/tpLetterspacing/plugin.js&quot;</span>;
...
</code><div class="language-text" >vue</div></pre>`}:y.methods={source(){return`<pre class="hljs fv-hljs "><ul class="highlight-line-number "  ><li ><span>1</span></li><li ><span>2</span></li><li ><span>3</span></li><li ><span>4</span></li><li ><span>5</span></li><li ><span>6</span></li><li ><span>7</span></li><li ><span>8</span></li><li ><span>9</span></li><li ><span>10</span></li><li ><span>11</span></li><li ><span>12</span></li><li ><span>13</span></li><li ><span>14</span></li><li ><span>15</span></li><li ><span>16</span></li><li ><span>17</span></li><li ><span>18</span></li><li ><span>19</span></li><li ><span>20</span></li><li ><span>21</span></li><li ><span>22</span></li><li ><span>23</span></li><li ><span>24</span></li><li ><span>25</span></li><li ><span>26</span></li><li ><span>27</span></li><li ><span>28</span></li><li ><span>29</span></li><li ><span>30</span></li><li ><span>31</span></li><li ><span>32</span></li><li ><span>33</span></li><li ><span>34</span></li><li ><span>35</span></li><li ><span>36</span></li><li ><span>37</span></li><li ><span>38</span></li><li ><span>39</span></li><li ><span>40</span></li><li ><span>41</span></li><li ><span>42</span></li><li ><span>43</span></li><li ><span>44</span></li><li ><span>45</span></li><li ><span>46</span></li></ul><code class=" hljs  hljs-js" @click.stop="()=>{}">&lt;template&gt;
<span class="language-xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span>&gt;</span>
 <span class="hljs-tag">&lt;<span class="hljs-name">h1</span>&gt;</span>\u63D2\u4EF6demo\u5C55\u793A\u533A\u57DF<span class="hljs-tag">&lt;/<span class="hljs-name">h1</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;vueDemo&quot;</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">tinymce-vue</span> <span class="hljs-attr">v-model</span>=<span class="hljs-string">&quot;content&quot;</span> <span class="hljs-attr">:init</span>=<span class="hljs-string">&quot;tinymceOptions&quot;</span> &gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">tinymce-vue</span>&gt;</span>
...
<span class="hljs-title function_">data</span>(<span class="hljs-params"></span>){
...
</code><div class="language-text" >vue</div></pre>`}};y.template=`<Preview class="demo-introduction_t_ovg6041668152443903_p_" :source="source()">
 ...
 <h1>\u63D2\u4EF6demo\u5C55\u793A\u533A\u57DF</h1>
  ...
  <div  v-html="content"></div>
                              ...
                              </Preview>`;const C=k({components:{Demo0:y},template:`<div class="fv-mardown-html"><div class="fv-mardown-main tp-doc"><h1 id="Welcome!" tabindex="-1"><a class="header-anchor" href="#\u{1F44B} Welcome !">#</a> <strong>\u{1F44B} Welcome !</strong></h1>
<hr>
<blockquote>
...
<codeBoxItem title="TinyMCE"><iframe scrolling="no" style="width:100%;margin:auto 0;border:0px; min-height: 220px"  onload="autoIframeHeight(this)"  src="/demo/codebox/demo-introduction_t_ovg6041668152443903_p_1668152450361/index.html"></iframe></codeBoxItem></codeBox><Demo0 data-isComponent="vue" class="demo-introduction_t_ovg6041668152443903_p_" />
<p>\u66F4\u591A\u4F8B\u5B50\u89C1<a href="/contributing/writing-guide/grammar-demo.html">\u53C2\u4E0E\u8D21\u732E</a></p>
</div></div><PagesRouter  docPath="guide/introduction.md" mapType="docs" docRepo="tinymce-plugin-docs" pagesName="introduction_t_ovg6041668152443903_p_" />`});export{C as default};
