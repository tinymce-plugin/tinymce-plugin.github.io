...
<span class="hljs-title function_">data</span>(<span class="hljs-params"></span>){
...
</code><div class="language-text" >vue</div></pre>`}};s.template=`<Preview class="demo-tpLayoutDemo_t_xqx3f91668152443903_p_" :source="source()">
 ...
 <h1>\u63D2\u4EF6demo\u5C55\u793A\u533A\u57DF</h1>
  ...
  <div  v-html="content"></div>
                              ...
                              </Preview>`;const e=n({components:{Demo0:s},template:`<div class="fv-mardown-html"><div class="fv-mardown-main tp-doc"><Demo0 data-isComponent="vue" class="demo-tpLayoutDemo_t_xqx3f91668152443903_p_" />
</div></div><PagesRouter  docPath="__docs__/tpLayoutDemo.md" mapType="docs" docRepo="tp-layout" pagesName="tpLayoutDemo_t_xqx3f91668152443903_p_" />`});export{e as default};
