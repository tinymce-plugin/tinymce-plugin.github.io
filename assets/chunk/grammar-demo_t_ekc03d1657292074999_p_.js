...
</code><div class="language-text" >html</div></pre>`},sourceCode(){return'<iframe scrolling="no" width="100%" style="width:100%;margin:auto 0;border:0px; min-height: 519px"  onload="autoIframeHeight(this)"  src="/demo/demo-grammar-demo_t_ekc03d1657292074999_p_1657293114201/index.html"></iframe>'}};o.template=`<PreviewIframe class="demo-grammar-demo_t_ekc03d1657292074999_p_" idx="Demo0"  :source="source()" :sourceCode="sourceCode()">
...
</code><div class="language-text" >html</div></pre>`},sourceCode(){return'<iframe scrolling="no" width="100%" style="width:100%;margin:auto 0;border:0px; min-height: 519px"  onload="autoIframeHeight(this)"  src="/demo/demo-grammar-demo_t_ekc03d1657292074999_p_1657293114230/index.html"></iframe>'}};j.template=`<PreviewIframe class="demo-grammar-demo_t_ekc03d1657292074999_p_" idx="Demo4"  :source="source()" :sourceCode="sourceCode()">
