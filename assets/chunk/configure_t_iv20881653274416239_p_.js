  ...
  <span class="hljs-tag">&lt;<span class="hljs-name">body</span>&gt;</span>
    ...
    <span class="hljs-tag">&lt;<span class="hljs-name">script</span>&gt;</span><span class="language-javascript">
     ...
     tinymce.<span class="hljs-title function_">init</span>({
        ...
        <span class="hljs-attr">plugins</span>: <span class="hljs-string">&#x27;code tpImportword&#x27;</span>,
...
</code><div class="language-text" >html</div></pre>`},sourceCode(){return'<iframe scrolling="no" style="width:100%;margin:auto 0;border:0px; min-height: 220px"  onload="autoIframeHeight(this)"  src="/demo/demo-configure_t_iv20881653274416239_p_1653274419881/index.html"></iframe>'}};s.template=`<PreviewIframe class="demo-configure_t_iv20881653274416239_p_" idx="Demo0"  :source="source()" :sourceCode="sourceCode()">
...
</div></div><PagesRouter  docPath="__docs__/configure.md" mapType="docs" docRepo="tp-importword" pagesName="configure_t_iv20881653274416239_p_" />`});export{p as default};
