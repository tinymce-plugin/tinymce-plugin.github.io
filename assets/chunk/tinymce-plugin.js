...
`;return document.querySelector(t.selector).outerHTML=n+document.querySelector(t.selector).outerHTML,a},rt=(t,a,n)=>{let e="";e=b.buttonsStyle&&b.buttonsStyle[a],n||(n=_(t.tp$CustomTags.buttons.styleSheetList)),e||(e=b.buttonsStyle&&(b.buttonsStyle[a]=n[0]));let i="",o="",r="";return n.forEach((s,l)=>{s===e&&(o=`<span class="tp-buttons" data-tp-style="${s}">${D(s)}</span>`),i+=`<li ><input id="${a+"_"+l}" type="radio" name="${a}" ${e===s?" checked ":""}  onclick="tinymce.tp$HtmlPanelFn(this,'${a}','${s}')"> <label for="${a+"_"+l}" > <span class="tp-buttons" data-tp-style="${s}">${D(s)}</span></label></li>
`,r+=k(t.tp$CustomTags.buttons.styleSheetList[s],s)}),`<div style="width: 100%; position: relative; " >
  ...
  :host {
      overflow: hidden;
      display: block; 
  }`,o.innerHTML=e.template.innerHTML;class l extends t.HTMLElement{constructor(){super(),this.setAttribute("contenteditable",!1),this.setAttribute("data-mce-tp-component",i),this.attachShadow({mode:"open"}),this.tp$state=typeof e.state=="object"?JSON.parse(JSON.stringify(e.state)):{},B(n,this,"init",e),this.tpComponentDelete=typeof e.tpComponentDelete=="function"?e.tpComponentDelete.bind(this):()=>{this.remove()},this.tpComponentCmd=typeof e.tpComponentCmdFn=="object"?JSON.stringify(e.tpComponentCmdFn)!=="{}"?(c,x)=>{e.tpComponentCmdFn[c](this,x),B(n,this,c,e)}:(c,x)=>{g.customTags[i].tpComponentCmdFn[c](this,x),B(n,this,c,e)}:()=>{console.log("\u65E0\u53EF\u7528cmd")},s.id="tpComponentStyle_"+this.getAttribute("data-id"),i=="tabs"&&(s.textContent=e.styleSheetLoadList&&e.styleSheetLoadList[this.getAttribute("data-tp-style")||"default"]?e.styleSheetLoadList[this.getAttribute("data-tp-style")||"default"].replace(/.tp-tabs\s*\{/g,":host   {").replace(/.tp-tabs_label\b\s/g,"::slotted(.tp-tabs_label)   ").replace(/.tp-tabs_label:hover\b\s/g,"::slotted(.tp-tabs_label:hover)   ").replace(/.tp-tabs_label.checked\b\s/g,"::slotted(.tp-tabs_label.checked)   "):""),i=="collapse"&&(s.textContent=e.styleSheetLoadList&&e.styleSheetLoadList[this.getAttribute("data-tp-style")||"default"]?e.styleSheetLoadList[this.getAttribute("data-tp-style")||"default"].replace(/>/g," ").replace(/.tp-collapse\s*\{/g,":host   {").replace(/label.tp-collapse_label\b\s/g,"::slotted(.tp-collapse_label)   ").replace(/label.tp-collapse_label::/g,"::slotted(.tp-collapse_label)::").replace(/.tp-tabs_label:hover\b\s/g,"::slotted(.tp-tabs_label:hover)   ").replace(/.tp-tabs_label.checked\b\s/g,"::slotted(.tp-tabs_label.checked)   "):""),i=="buttons"&&(s.textContent=e.styleSheetList&&e.styleSheetList[this.getAttribute("data-tp-style")||"default"]?k(e.styleSheetList[this.getAttribute("data-tp-style")||"default"],this.getAttribute("data-tp-style")||"default").replace(/\[data-tp-style=(.*?)\]/g,"").replace(/>/g," ").replace(/.tp-buttons\s*\{/g,":host   {").replace(/.tp-buttons:hover\s*\{/g,":host(:hover)   {").replace(/.tp-buttons::before\s*\{/g,":host(.tp-buttons)::before   {").replace(/.tp-buttons::after\s*\{/g,":host(.tp-buttons)::after   {"):""),o.content.prepend(s),o.content.prepend(r),this.shadowRoot.appendChild(o.content.cloneNode(!0))}connectedCallback(){y(e,"headerEditableFn")(this,e.isHeaderEditable,i,n),y(e,"contentEditableFn")(this,e.isContentEditable,i,n),y(e,"connectedCallback")(this.shadowRoot,this)}static get observedAttributes(){return["data-top-bg","data-mce-tp-component","data-value"]}static tp$Delete(){console.log(this)}}try{t.customElements.define("tp-"+i,l)}catch{}},ct=t=>{const a=t.getWin(),n=t.getDoc();let e=t.toolbar,i=t.baseURI.source;typeof e=="object"&&(e=e.jion(" ")),/tpIconlists/.test(e)&&W.send({url:i+"plugins/tpIconlists/tpIconlists.css",async:!1,dataType:"text",success:function(s){t.dom.addStyle(s)}}),pt(t),ut(t);const o=`.mce-content-body [data-mce-tp-component][contenteditable=false][data-mce-selected] {
      outline: none;
      cursor: default;
...
<div class="tp-collapse_mainBox">
  ...
  .skt-loading .skeleton.badge:after {
  background-color: #f8fafc
  }`,gt=t=>{if(!document.querySelector("style#skt-tox-style")){let l=document.createElement("style");l.type="text/css",l.id="skt-tox-style";try{l.appendChild(document.createTextNode(j()))}catch{l.styleSheet.cssText=j()}document.getElementsByTagName("head")[0].appendChild(l)}if(!document.querySelector("style#skt-dark-tox-style")){let l=document.createElement("style");l.type="text/css",l.id="skt-dark-tox-style";try{l.appendChild(document.createTextNode(U()))}catch{l.styleSheet.cssText=U()}document.getElementsByTagName("head")[0].appendChild(l)}let a=[];typeof t.toolbar=="string"?a=O(t.toolbar):Array.isArray(t.toolbar)&&t.toolbar.forEach(l=>{a.push(...O(l))});let n=[];if(t.menubar!==!1)if(typeof t.menubar=="string")n=ht(t.menubar);else for(let l in E.title)R[l]&&n.push(E.title[l][t.language||"en_US"]);let e=t.min_height||t.height||200,i=[],o=e-150;for(let l=0;l<o;l+=50)i.push("1");let r=t.selector?document.querySelector(t.selector).parentNode:t.target.parentNode,s=document.createElement("div");return s.className="skt skt-loading",/dark$/.test(t.skin)&&s.setAttribute("data-isdark","true"),s.innerHTML=ft({selector:t.selector,toolbar:a,menubar:n,branding:t.branding!==!1,placeholderList:i,height:e}),r.style.position="relative",r.style.minHeight=e+"px",r.append(s),s},mt=t=>{let a="";return t.forEach(n=>{typeof n=="object"?n.forEach(e=>{a+='<button  class="skt-tox-mbtn skt-tox-mbtn--select"><span class="skt-tox-mbtn__select-label skeleton">'+e+`</span></button>
...
}`:"")+e+i+o+n+c};const kt={iframeLayout:`
   <style>
