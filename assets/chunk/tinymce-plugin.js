...
*  @version 0.0.3-beta.19 (2022-7-5)
...
*/(function(){let c=tinymce,w=c.util.Tools,f=c.html.Node;c.html.Schema;let W=c.util.XHR,S=c.util.I18n,q=new c.html.Serializer().serialize,G=new c.html.DomParser().parse,b={};window.tp$State=b;let h=(t,a)=>{let n=a?a.match(new RegExp(t+':(.+?)"?[;}]')):"";return n?n[1]:!1};function z(t,a,n,e){t.tp$Style.mapping&&t.tp$Style.mapping[""+a.getAttribute("data-id")]&&(t.tp$Style.mapping[""+a.getAttribute("data-id")].specialStyle[""+n]=e)}let g={customTags:{}},_=Object.keys,m=function(){return m=Object.assign||function(a){for(var n,e=1,i=arguments.length;e<i;e++){n=arguments[e];for(var o in n)Object.prototype.hasOwnProperty.call(n,o)&&(a[o]=n[o])}return a},m.apply(this,arguments)},X=Object.hasOwnProperty;var Y=function(t){return t==null},Z=function(t){return!Y(t)};const C=t=>{if(typeof t=="object")return JSON.stringify(t).replace(/"([-A-Za-z]+?)":""[,}]/g,"").replace(/,/gi,";").replace(/{/gi,"").replace(/}/gi,"").replace(/"/gi,"")},A=t=>typeof t=="string"&&t!=="{}"?(t=JSON.stringify(t),JSON.parse(("{"+t.replace(/:/g,'": "').replace(/;\s*/g,'","')+"}").replace(/,\"\"\}$/,"}"))):t,v=(t,a)=>{const n=a.match(new RegExp(`.${t}\\s*\\{([\\s\\S]+)\\}`));return n&&n[1]?n[1].replace(/\}([\s\S]+)/,"").trim():""};var Q=function(t,a){return X.call(t,a)},tt=function(t,a,n,e){e===void 0&&(e=null);var i=t.attr(n);return Z(i)?i:Q(a,n)?null:e};const L=t=>t.replace(/[-|\_](\w)/g,function(a,n){return n.toUpperCase()}),et=t=>t.replace(/([A-Z])/g,"_$1").toLowerCase().replace(/\-/g,"_"),at=t=>t.replace(/([A-Z])/g,"-$1").toLowerCase().replace(/\_/g,"-");var nt=function(t,a){let n="";if(!t)return"";for(a=L(a);t.nodeName!=="P"&&t.nodeName!=="LI"&&t.nodeName!=="DIV"&&t.nodeName!=="BODY";){if(t.style[a]){n=t.style[a];break}t=t.parentNode}return n};let k=(t,a)=>{let n="";return n+=t["tp-buttons"]?'.tp-buttons[data-tp-style="'+a+'"] {'+t["tp-buttons"]+`}
...
`:"",n};const it=(t,a,n)=>{!n&&(n=a*100);let e={id:null,outTime:n,outId:null};e.id=setInterval(i=>{t(()=>{clearTimeout(i.outId),clearInterval(i.id)})},a,e),e.outId=setTimeout(()=>{e.id&&clearInterval(e.id)},e.outTime)};let y=function(t,a){return typeof t[a]=="function"?t[a]:typeof g.customTags[t.name][a]=="function"?g.customTags[t.name][a]:function(){}};const ot=(t,a)=>a?typeof t=="string"&&!t.match(/\s/)&&t.length>0?parseInt(t)+"px":t:typeof t=="string"&&t.length>0&&t.match(/^[0-9]{1,8}$/)?t+"px":t,D=t=>{let a=t.split("_");return a.length>1?S.translate([a[0]+" {0}",a[1]]):S.translate(t)};tinymce.tp$HtmlPanelFn=window.tp$HtmlPanelFn=function(t,a,n){b.buttonsStyle&&(b.buttonsStyle[a]=n),document.querySelector("#"+a+"_StyleID").innerHTML=t.nextElementSibling.innerHTML};const st={count:0},lt=t=>{let a=new Date().getTime()+"-"+st.count++,n=`
...
`;return document.querySelector(t.selector).outerHTML=n+document.querySelector(t.selector).outerHTML,a},rt=(t,a,n)=>{let e="";e=b.buttonsStyle&&b.buttonsStyle[a],n||(n=_(t.tp$CustomTags.buttons.styleSheetList)),e||(e=b.buttonsStyle&&(b.buttonsStyle[a]=n[0]));let i="",o="",l="";return n.forEach((r,s)=>{r===e&&(o=`<span class="tp-buttons" data-tp-style="${r}">${D(r)}</span>`),i+=`<li ><input id="${a+"_"+s}" type="radio" name="${a}" ${e===r?" checked ":""}  onclick="tinymce.tp$HtmlPanelFn(this,'${a}','${r}')"> <label for="${a+"_"+s}" > <span class="tp-buttons" data-tp-style="${r}">${D(r)}</span></label></li>
`,l+=k(t.tp$CustomTags.buttons.styleSheetList[r],r)}),`<div style="width: 100%; position: relative; " >
  ...
  :host {
      overflow: hidden;
      display: block; 
  }`,o.innerHTML=e.template.innerHTML;class s extends t.HTMLElement{constructor(){super(),this.setAttribute("contenteditable",!1),this.setAttribute("data-mce-tp-component",i),this.attachShadow({mode:"open"}),this.tp$state=typeof e.state=="object"?JSON.parse(JSON.stringify(e.state)):{},B(n,this,"init",e),this.tpComponentDelete=typeof e.tpComponentDelete=="function"?e.tpComponentDelete.bind(this):()=>{this.remove()},this.tpComponentCmd=typeof e.tpComponentCmdFn=="object"?JSON.stringify(e.tpComponentCmdFn)!=="{}"?(p,x)=>{e.tpComponentCmdFn[p](this,x),B(n,this,p,e)}:(p,x)=>{g.customTags[i].tpComponentCmdFn[p](this,x),B(n,this,p,e)}:()=>{console.log("\u65E0\u53EF\u7528cmd")},r.id="tpComponentStyle_"+this.getAttribute("data-id"),i=="tabs"&&(r.textContent=e.styleSheetLoadList&&e.styleSheetLoadList[this.getAttribute("data-tp-style")||"default"]?e.styleSheetLoadList[this.getAttribute("data-tp-style")||"default"].replace(/.tp-tabs\s*\{/g,":host   {").replace(/.tp-tabs_label\b\s/g,"::slotted(.tp-tabs_label)   ").replace(/.tp-tabs_label:hover\b\s/g,"::slotted(.tp-tabs_label:hover)   ").replace(/.tp-tabs_label.checked\b\s/g,"::slotted(.tp-tabs_label.checked)   "):""),i=="collapse"&&(r.textContent=e.styleSheetLoadList&&e.styleSheetLoadList[this.getAttribute("data-tp-style")||"default"]?e.styleSheetLoadList[this.getAttribute("data-tp-style")||"default"].replace(/>/g," ").replace(/.tp-collapse\s*\{/g,":host   {").replace(/label.tp-collapse_label\b\s/g,"::slotted(.tp-collapse_label)   ").replace(/label.tp-collapse_label::/g,"::slotted(.tp-collapse_label)::").replace(/.tp-tabs_label:hover\b\s/g,"::slotted(.tp-tabs_label:hover)   ").replace(/.tp-tabs_label.checked\b\s/g,"::slotted(.tp-tabs_label.checked)   "):""),i=="buttons"&&(r.textContent=e.styleSheetList&&e.styleSheetList[this.getAttribute("data-tp-style")||"default"]?k(e.styleSheetList[this.getAttribute("data-tp-style")||"default"],this.getAttribute("data-tp-style")||"default").replace(/\[data-tp-style=(.*?)\]/g,"").replace(/>/g," ").replace(/.tp-buttons\s*\{/g,":host   {").replace(/.tp-buttons:hover\s*\{/g,":host(:hover)   {").replace(/.tp-buttons::before\s*\{/g,":host(.tp-buttons)::before   {").replace(/.tp-buttons::after\s*\{/g,":host(.tp-buttons)::after   {"):""),o.content.prepend(r),o.content.prepend(l),this.shadowRoot.appendChild(o.content.cloneNode(!0))}connectedCallback(){y(e,"headerEditableFn")(this,e.isHeaderEditable,i,n),y(e,"contentEditableFn")(this,e.isContentEditable,i,n),y(e,"connectedCallback")(this.shadowRoot,this)}static get observedAttributes(){return["data-top-bg","data-mce-tp-component","data-value"]}static tp$Delete(){console.log(this)}}try{t.customElements.define("tp-"+i,s)}catch{}},ct=t=>{const a=t.getWin(),n=t.getDoc();let e=t.toolbar,i=t.baseURI.source;typeof e=="object"&&(e=e.jion(" ")),/tpIconlists/.test(e)&&W.send({url:i+"plugins/tpIconlists/tpIconlists.css",async:!1,dataType:"text",success:function(r){t.dom.addStyle(r)}}),pt(t),ut(t);const o=`.mce-content-body [data-mce-tp-component][contenteditable=false][data-mce-selected] {
      outline: none;
      cursor: default;
  ...
  .mce-content-body *[contentEditable=false] *[contentEditable=true]:hover {
      outline: none!important;
  }`;t.dom.addStyle(o),t.tp$Style={},t.getTpStyle=r=>"<style>"+t.tp$OutputStyle+" </style>";let l=t.tp$CustomTags||g.customTags;w.each(l,function(r,s){dt(a,n,t,r,s)}),t.parser.addAttributeFilter("data-tp-component",r=>{r&&r.forEach(s=>{let u=s.attr("data-tp-component");l[u]&&y(l[u],"parserFn")(s,u,t)})}),t.serializer.addAttributeFilter("data-mce-tp-component",r=>{r&&r.forEach(s=>{let u=s.attr("data-mce-tp-component");l[u]&&y(l[u],"serializerFn")(s,u,t)})}),t.setContent(t.getContent({source_view:!0}))},T=(t,a,n,e,i)=>{e?(!e.tp$CustomTags&&(e.tp$CustomTags=JSON.parse(JSON.stringify(g.customTags))),i?m(e.tp$CustomTags[t][a],n):e.tp$CustomTags[t][a]=n):i?m(g.customTags[t][a],n):g.customTags[t][a]=n},P={custom_elements:"",setCustomTags:T,createCustomTags:(t,a,n)=>{n?(!n.tp$CustomTags&&(n.tp$CustomTags=JSON.parse(JSON.stringify(g.customTags))),n.tp$CustomTags[t]=a):g.customTags[t]=a},setStyleSheetList:(t,a,n,e)=>{T("buttons","styleSheetList",{[a]:{"tp-buttons":v("tp-buttons",n),"tp-buttons:hover":v("tp-buttons:hover",n),"tp-buttons::before":v("tp-buttons::before",n),"tp-buttons::after":v("tp-buttons::after",n)}},e,!0)},createHtmlPanel:rt};var I={name:"tabs",styleSheet:{selector:"default",styleSheetList:{default:{"tp-tabs":"","tp-tabs_top":"","tp-tabs_label.checked":" ","tp-tabs_main":" ","tp-tab_main.checked":" "}}},styleSheetLoadList:{},styleFn:()=>{},state:{count:0},tpComponentDeleteFn:function(){console.log(this)},tpComponentMonitorCmd:()=>{},tpComponentCmdFn:{tabAdd:(t,a)=>{let n=document.createElement("div");n.setAttribute("contenteditable",!1),n.setAttribute("class","tp-partition tp-tabs_label"),n.setAttribute("data-idx",t.tp$state.count);let e=document.createElement("p");e.setAttribute("class","tp-component_inline"),e.setAttribute("data-idx",t.tp$state.count),e.setAttribute("contenteditable",!0),e.innerHTML=a.title,n.appendChild(e),t.insertBefore(n,t.lastChild);let i=document.createElement("div");i.setAttribute("class","tp-tab_main"),i.setAttribute("style","overflow: hidden; max-height: 0; transition: all 0s"),i.innerHTML=a.content,t.lastChild.appendChild(i),t.tp$state.count++},tabDelete:(t,a)=>{t.children[--t.tp$state.count].remove(),t.lastChild.lastChild.remove()},delete:(t,a)=>{t.remove()},getStyle:(t,a)=>{},setStyle:(t,a)=>{console.log(t.querySelector(".tp-tabs_top")),t.setAttribute("data-top-style",a["tp-tabs_top"]),t.shadowRoot.querySelector(".tp-tabs_top").setAttribute("style",a["tp-tabs_top"])}},template:{innerHTML:`
<div class="tp-tabs">
...
<div class="tp-buttons_main">
    ...
    `},styleSheetList:{default:{"tp-buttons":`
          ...
          text-decoration: none;`,"tp-buttons:hover":`
           ...
           `,"tp-buttons::before":" ","tp-buttons::after":" "}},isContentEditable:!0,connectedCallback:()=>{},tpComponentCmdFn:{upData:(t,a)=>{t.shadowRoot.children[1].textContent=k(a.editor.tp$CustomTags.buttons.styleSheetList[a.styleName],a.styleName).replace(/\[data-tp-style=(.*?)\]/g,"").replace(/>/g," ").replace(/.tp-buttons\s*\{/g,":host   {").replace(/.tp-buttons:hover\s*\{/g,":host(:hover)   {").replace(/.tp-buttons::before\s*\{/g,":host(::before)   {").replace(/.tp-buttons::after\s*\{/g,":host(::after)   {")}},contentEditableFn:(t,a,n,e)=>{if(t.firstChild&&t.firstChild.tagName==="A"){const i=document.createElement("p");i.setAttribute("contenteditable",!0),i.setAttribute("class","tp-component_inline"),t.firstChild.innerHTML="<span>"+t.firstChild.innerHTML+"</span>",t.firstChild.setAttribute("href","javascript:;"),i.appendChild(t.firstChild),t.appendChild(i)}},isHeaderEditable:!0,parserFn:(t,a,n)=>{t.attr({"data-tp-component":null});let e=t.attr("style"),i={},o="";o=h("margin",e),o&&(i.margin=o),o=h("padding",e),o&&(i.padding=o),o=h("border",e),o&&(i.border=o),o=h("background",e),o&&(i.background=o),o=h("border-radius",e),o&&(i["border-radius"]=o),o=h("border-width",e),o&&(i["border-width"]=o),o=h("border-style",e),o&&(i["border-style"]=o),o=h("border-color",e),o&&(i["border-color"]=o);let l=new f("div",1);l.type=1,l.attr({"data-mce-tp-component":a,"data-tp-style":t.attr("data-tp-style")||"default",style:C(i)||null,"data-id":t.attr("data-id")}),t.attr("class")&&l.attr("class",t.attr("class")),n.tp$Style.mapping||(n.tp$Style.mapping={}),n.tp$Style.mapping[""+t.attr("data-id")]?m(n.tp$Style.mapping[""+t.attr("data-id")],{styleTemplate:t.attr("data-tp-style")||"default"}):n.tp$Style.mapping[""+t.attr("data-id")]={styleCustomTags:"buttons",stylePath:"styleSheetList",styleTemplate:t.attr("data-tp-style")||"default",specialStyle:{}},t.attr("style",C(m(A(t.attr("style"))||{},{margin:"",padding:"",background:"","border-style":"","border-color":"","border-width":"","border-radius":"",border:""}))||null),t.attr("data-id",null),t.attr("data-mce-style",null),t.wrap(l),l.name="tp-"+a},serializerFn:(t,a)=>{let n=t;for(;n.name!=="a"&&n.firstChild.name!=="#text";)n=n.firstChild;t.attr({"data-mce-tp-component":null,"data-tp-component":a,contenteditable:null,"data-tp-style":t.attr("data-tp-style")||"default",href:n&&n.attr("href")?n.attr("href"):null,style:n&&n.attr("style")?C(m(A(t.attr("style"))||{},A(n.attr("style"))||{})):t.attr("style"),target:n&&n.attr("target")?n.attr("target"):null,rel:n&&n.attr("rel")?n.attr("rel"):null,title:n&&n.attr("title")?n.attr("title"):null}),t.firstChild.unwrap(),n&&n.unwrap(),t.name="a"}},$={name:"collapse",template:{innerHTML:`
...
<div class="tp-collapse_mainBox">
    ...
    `},isContentEditable:!0,connectedCallback:()=>{},tpComponentCmdFn:{upData:(t,a)=>{let n=a.style,e=h("padding",n),i=h("border",n),o=h("border-width",n);z(a.editor,t,"tp-collapse_main",(e?"padding: "+e+"!important; ":"")+(i?"border: "+i+"!important;":"")+(o?"border-width: "+o+"!important;":""))}},contentEditableFn:(t,a,n,e)=>{const i=document.createElement("div");if(i.setAttribute("contenteditable",!1),i.setAttribute("class","tp-partition tp-collapse_main"),a&&t.lastChild.setAttribute("contenteditable",!0),t.lastChild.getAttribute("class")==="tp-collapse_main"){let o=t.lastChild.getAttribute("style"),l=h("padding",o),r=h("border",o),s=h("border-width",o);z(e,t,"tp-collapse_main",(l?"padding: "+l+"!important; ":"")+(r?"border: "+r+"!important;":"")+(s?"border-width: "+s+"!important;":""))}i.appendChild(t.lastChild),t.appendChild(i)},isHeaderEditable:!0,headerEditableFn:(t,a,n,e)=>{if(t.firstChild.contenteditable!=="true"){const i=document.createElement("div");for(a&&i.setAttribute("contenteditable",!0),i.setAttribute("slot","header"),i.setAttribute("class","tp-collapse_label"),i.setAttribute("style","min-height: 20px; "+t.getAttribute("data-top-style"));t.firstChild&&t.firstChild.className!=="tp-"+n+"_main";)i.appendChild(t.firstChild);t.insertBefore(i,t.firstChild)}},parserFn:(t,a)=>{t.attr({"data-tp-component":null,"data-mce-tp-component":a}),t.attr("data-id",t.firstChild.attr("id")),t.firstChild.remove(),t.lastChild.attr("class","tp-"+a+"_main"),t.type=1,t.name="tp-"+a},serializerFn:(t,a)=>{t.attr({"data-mce-tp-component":null,"data-tp-component":a,contenteditable:null,class:"tp-"+a}),t.firstChild.type=1,t.firstChild.name="label",t.firstChild.attr({contenteditable:null,for:t.attr("data-id")});let n=t.lastChild.attr("style");t.lastChild.unwrap(),t.lastChild.attr({contenteditable:null,class:"tp-"+a+"_main",style:n});let e=new f("input",1);e.shortEnded=!0,e.attr({id:t.attr("data-id"),type:"checkbox"}),t.insert(e,t.firstChild,!0),t.attr("data-id",null),t.type=1,t.name="div"}};const V=t=>/select$/.test(t),N={forecolor:!0,backcolor:!0,tpLetterspacing:!0,tpIconlists:!0,tpColumns:!0,table:!0},E={title:{file:{zh_CN:"\u6587\u4EF6",en_US:"File"},edit:{zh_CN:"\u7F16\u8F91",en_US:"Edit"},view:{zh_CN:"\u67E5\u770B",en_US:"View"},insert:{zh_CN:"\u63D2\u5165",en_US:"Insert"},format:{zh_CN:"\u683C\u5F0F",en_US:"Format"},table:{zh_CN:"\u8868\u683C",en_US:"Table"},tools:{zh_CN:"\u5DE5\u5177",en_US:"Tools"},help:{zh_CN:"\u5E2E\u52A9",en_US:"Help"}},items:{code:"tools",spellchecker:"tools",spellcheckerlanguage:"tools",wordcount:"tools",image:"insert",link:"insert",media:"insert",hr:"insert",template:"insert",codesample:"insert",charmap:"insert",inserttable:"table",emoticons:"insert",pagebreak:"insert",nonbreaking:"insert",anchor:"insert",toc:"insert",insertdatetime:"insert",bold:"format",italic:"format",underline:"format",strikethrough:"format",blockquote:"format",subscript:"format",superscript:"format",removeformat:"format",formatselect:"format",fontselect:"format",fontsizes:"format",forecolor:"format",backcolor:"format",fontformats:"format",blockformats:"format",codeformat:"format",align:"format",table:"table",lineheight:"format",help:"help"}},R={file:!0,view:!0,edit:!0},O=t=>{let a=[];return t.split("|").forEach(e=>{let i=e.split(" "),o=[];i.forEach(l=>{l&&o.push({isSelect:V(l),name:l}),l&&E.items[l]&&(R[E.items[l]]=!0)}),o.length>0&&a.push(o)}),a},ht=t=>{let a=[];return t.split("|").forEach(e=>{let i=e.split(" "),o=[];i.forEach(l=>{l&&o.push({isSelect:V(l),name:l})}),a.push(o)}),a},j=()=>`.skt-tox-tinymce{
  ...
  .skt-loading .skeleton.badge:after {
  background-color: #f8fafc
  }`,gt=t=>{if(!document.querySelector("style#skt-tox-style")){let s=document.createElement("style");s.type="text/css",s.id="skt-tox-style";try{s.appendChild(document.createTextNode(j()))}catch{s.styleSheet.cssText=j()}document.getElementsByTagName("head")[0].appendChild(s)}if(!document.querySelector("style#skt-dark-tox-style")){let s=document.createElement("style");s.type="text/css",s.id="skt-dark-tox-style";try{s.appendChild(document.createTextNode(U()))}catch{s.styleSheet.cssText=U()}document.getElementsByTagName("head")[0].appendChild(s)}let a=[];typeof t.toolbar=="string"?a=O(t.toolbar):Array.isArray(t.toolbar)&&t.toolbar.forEach(s=>{a.push(...O(s))});let n=[];if(t.menubar!==!1)if(typeof t.menubar=="string")n=ht(t.menubar);else for(let s in E.title)R[s]&&n.push(E.title[s][t.language||"en_US"]);let e=t.min_height||t.height||200,i=[],o=e-150;for(let s=0;s<o;s+=50)i.push("1");let l=t.selector?document.querySelector(t.selector).parentNode:t.target.parentNode,r=document.createElement("div");return r.className="skt skt-loading",/dark$/.test(t.skin)&&r.setAttribute("data-isdark","true"),r.innerHTML=ft({selector:t.selector,toolbar:a,menubar:n,branding:t.branding!==!1,placeholderList:i,height:e}),l.style.position="relative",l.style.minHeight=e+"px",l.append(r),r},mt=t=>{let a="";return t.forEach(n=>{typeof n=="object"?n.forEach(e=>{a+='<button  class="skt-tox-mbtn skt-tox-mbtn--select"><span class="skt-tox-mbtn__select-label skeleton">'+e+`</span></button>
`}):a+='<button  class="skt-tox-mbtn skt-tox-mbtn--select"><span class="skt-tox-mbtn__select-label skeleton">'+n+`</span></button>
`}),a},bt=t=>{let a="";return t.forEach(n=>{a+=`<div class="skt-tox-toolbar__group">
`,n.forEach(e=>{a+='<button class="skt-tox-tbtn '+(e.isSelect?" skt-tox-tbtn--select":"")+(N[e.name]?" skt-tox-split-button":"")+'"><span class="'+(e.isSelect?"skt-tox-tbtn__select-label skt-tox-tbtn--select":"skt-tox-icon tox-tbtn__icon-wrap")+' skeleton">'+e.name+"</span>"+(e.isSelect||N[e.name]?'<div class="skt-tox-tbtn__select-chevron skeleton"></div>':"")+`</button>
`}),a+=`</div>
`}),a},xt=t=>{let a="";return t.forEach(n=>{a+=`<p class="skeleton"></p>
`}),a},ft=t=>`
...
</div>`;g.customTags[I.name]=I,g.customTags[M.name]=M,g.customTags[$.name]=$;let yt=(t,a,n)=>{let e=`
...
}`:"")+e+i+o+n+p};const kt={iframeLayout:`
   <style>
