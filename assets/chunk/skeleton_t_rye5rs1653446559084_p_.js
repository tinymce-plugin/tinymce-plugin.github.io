...
</code><div class="language-text" >html</div></pre>`},sourceCode(){return'<iframe scrolling="no" style="width:100%;margin:auto 0;border:0px; min-height: 519px"  onload="autoIframeHeight(this)"  src="/demo/demo-skeleton_t_rye5rs1653446559084_p_1653446563302/index.html"></iframe>'}};s.template=`<PreviewIframe class="demo-skeleton_t_rye5rs1653446559084_p_" idx="Demo0"  :source="source()" :sourceCode="sourceCode()">
...
</div></div><PagesRouter  docPath="guide/skill/skeleton.md" mapType="docs" docRepo="tinymce-plugin-docs" pagesName="skeleton_t_rye5rs1653446559084_p_" />`});export{p as default};
