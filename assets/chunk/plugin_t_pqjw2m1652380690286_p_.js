...
<span class="hljs-tag">&lt;<span class="hljs-name">body</span> <span class="hljs-attr">tp-page-height</span>=<span class="hljs-string">&quot;498&quot;</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">h1</span>&gt;</span>\u5168\u90E8\u9B54\u6539\u9879\u76EE<span class="hljs-tag">&lt;/<span class="hljs-name">h1</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">&quot;demo&quot;</span>&gt;</span>
        ...
        <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
      <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
      <span class="hljs-comment">&lt;!-- &lt;a class=&quot;btn&quot; onclick=&quot;savefun()&quot; &gt;\u70B9\u51FB\u4FDD\u5B58\u663E\u793A&lt;/a&gt; --&gt;</span>
      <span class="hljs-comment">&lt;!-- &lt;div&gt;
         ...
         &lt;/div&gt;
     &lt;/div&gt; --&gt;</span>
     <span class="hljs-comment">&lt;!-- &lt;div style=&quot;height: 60px;&quot;&gt;&lt;/div&gt; --&gt;</span>
      ...
      $(<span class="hljs-string">&quot;#showID&quot;</span>).<span class="hljs-title function_">html</span>(tinymceConfig.<span class="hljs-title function_">getHtml</span>())
          ...
          tinymce.<span class="hljs-title function_">init</span>({
                ...
                <span class="hljs-comment">//  attachment_style: &#x27;.attachment&gt;img{display:inline-block!important;max-width:30px!important;}&#x27;,</span>
                 <span class="hljs-attr">tp_attachment_assets_path</span>: <span class="hljs-string">&#x27;./plugins/attachment/icons&#x27;</span>,
                 ...
                 tinymce.<span class="hljs-property">feedBackIframeUrl</span> =<span class="hljs-string">&#x27;./plugins/help/docBox.html&#x27;</span>; <span class="hljs-comment">//\u53CD\u9988\u94FE\u63A5</span>
                 tinymceConfig.<span class="hljs-property">setFCHtml</span> = <span class="hljs-keyword">function</span>(<span class="hljs-params">html</span>){<span class="hljs-comment">//\u8BBE\u7F6E\u529F\u80FD\u4ECB\u7ECDHtml</span>
                    tinymce.<span class="hljs-property">functionHtml</span> = html;
                  } 
                 tinymceConfig.<span class="hljs-property">setOMHtml</span> = <span class="hljs-keyword">function</span>(<span class="hljs-params">html</span>){<span class="hljs-comment">//\u8BBE\u7F6E\u64CD\u4F5C\u624B\u518CHtml</span>
                    tinymce.<span class="hljs-property">OperationManualHtml</span> = html;
                  } 
                  tinymceConfig.<span class="hljs-property">setCPHtml</span> = <span class="hljs-keyword">function</span>(<span class="hljs-params">html</span>){<span class="hljs-comment">//\u8BBE\u7F6E\u7591\u96BE\u95EE\u7B54Html</span>
                    tinymce.<span class="hljs-property">CommonProblemHtml</span> = html;
                  }
                  tinymceConfig.<span class="hljs-property">getHtml</span> = <span class="hljs-keyword">function</span> <span class="hljs-title function_">getHtml</span>(<span class="hljs-params"></span>){
                      <span class="hljs-keyword">let</span> _html = tinyMCE.<span class="hljs-property">editors</span>[tinymceConfig.<span class="hljs-property">tinyID</span>].<span class="hljs-title function_">getContent</span>();
                    <span class="hljs-keyword">return</span> _html;
                   }
				  
                  tinymceConfig.<span class="hljs-property">setHtml</span> = <span class="hljs-keyword">function</span> <span class="hljs-title function_">setHtml</span>(<span class="hljs-params">html</span>){
                      <span class="hljs-keyword">return</span> tinyMCE.<span class="hljs-property">editors</span>[tinymceConfig.<span class="hljs-property">tinyID</span>].<span class="hljs-title function_">setContent</span>(html);
                  }
                  $.<span class="hljs-title function_">ajax</span>({
                    <span class="hljs-attr">type</span>: <span class="hljs-string">&quot;GET&quot;</span>,
                    <span class="hljs-attr">url</span>: <span class="hljs-string">&quot;./api/setFChtml.json&quot;</span>,
                    ...
                    <span class="hljs-attr">success</span>: <span class="hljs-keyword">function</span>(<span class="hljs-params">data</span>) {
                       data.<span class="hljs-property">data</span>?tinymceConfig.<span class="hljs-title function_">setFCHtml</span>(data.<span class="hljs-property">data</span>) : <span class="hljs-string">&#x27;&#x27;</span>;<span class="hljs-comment">//\u8BBE\u7F6E\u529F\u80FD\u4ECB\u7ECD</span>
                    },
                  ...
                  $.<span class="hljs-title function_">ajax</span>({
                    <span class="hljs-attr">type</span>: <span class="hljs-string">&quot;GET&quot;</span>,
                    <span class="hljs-attr">url</span>: <span class="hljs-string">&quot;./api/setList.json&quot;</span>,
                    <span class="hljs-attr">async</span>: <span class="hljs-literal">true</span>,
                    <span class="hljs-attr">dataType</span>: <span class="hljs-string">&quot;json&quot;</span>,
                    <span class="hljs-attr">success</span>: <span class="hljs-keyword">function</span>(<span class="hljs-params">data</span>) {
                      <span class="hljs-keyword">let</span> temHtml=data.<span class="hljs-property">data</span>
                      temHtml? tinymceConfig.<span class="hljs-title function_">setOMHtml</span>(temHtml) : <span class="hljs-string">&#x27;&#x27;</span>
                    }
                  })
                      $.<span class="hljs-title function_">ajax</span>({
                        <span class="hljs-attr">type</span>: <span class="hljs-string">&quot;GET&quot;</span>,
                        <span class="hljs-attr">url</span>: <span class="hljs-string">&quot;./api/setCP.json&quot;</span>,
                        <span class="hljs-attr">async</span>: <span class="hljs-literal">true</span>,
                        <span class="hljs-attr">dataType</span>: <span class="hljs-string">&quot;json&quot;</span>,
                        <span class="hljs-attr">success</span>: <span class="hljs-keyword">function</span>(<span class="hljs-params">data</span>) {
                          tinymceConfig.<span class="hljs-title function_">setCPHtml</span>(data.<span class="hljs-property">data</span>);<span class="hljs-comment">//\u8BBE\u7F6E\u7591\u96BE\u95EE\u7B54</span>
                          <span class="hljs-keyword">let</span> _html = $(<span class="hljs-string">&quot;#&quot;</span>+tinymceConfig.<span class="hljs-property">tinyID</span>).<span class="hljs-title function_">html</span>();
                             <span class="hljs-keyword">if</span>(_html&amp;&amp;_html.<span class="hljs-title function_">indexOf</span>(<span class="hljs-string">&#x27;&lt;div id=&quot;fvContentID&quot;&gt;&#x27;</span>)!=-<span class="hljs-number">1</span>){
                                 _html = _html.<span class="hljs-title function_">match</span>(<span class="hljs-regexp">/&lt;div id=&quot;fvContentID&quot;&gt;([\\s\\S]*)&lt;\\/div&gt;/</span>)[<span class="hljs-number">1</span>];
                             }
                             _html?tinymceConfig.<span class="hljs-title function_">setHtml</span>(_html):<span class="hljs-string">&#x27;&#x27;</span>
                        },
                        <span class="hljs-attr">error</span>:<span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) {
                        }
                      })
                ...
                <span class="hljs-comment">//\u516C\u544A\u680F</span>
                 $.<span class="hljs-title function_">ajax</span>({
                    <span class="hljs-attr">type</span>: <span class="hljs-string">&quot;GET&quot;</span>,
                    <span class="hljs-attr">url</span>: <span class="hljs-string">&quot;./api/setGG.json&quot;</span>,
                    <span class="hljs-attr">async</span>: <span class="hljs-literal">true</span>,
                    <span class="hljs-attr">dataType</span>: <span class="hljs-string">&quot;json&quot;</span>,
                    <span class="hljs-attr">success</span>: <span class="hljs-keyword">function</span>(<span class="hljs-params">data</span>) {
                           $(<span class="hljs-string">&quot;#tinymce-app&quot;</span>).<span class="hljs-title function_">prepend</span>(<span class="hljs-string">&#x27;&lt;div&gt;&lt;p style=&quot;margin: 5px;&quot;&gt;\u3010\u516C\u544A\u680F\u3011&lt;/p&gt;&#x27;</span>+data.<span class="hljs-property">data</span>+<span class="hljs-string">&#x27;&lt;/div&gt;&#x27;</span>)
                    },
                    <span class="hljs-attr">error</span>:<span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) {
                    }
                  })
...
</code><div class="language-text" >html</div></pre>`},sourceCode(){return'<iframe scrolling="no" style="width:100%;margin:auto 0;border:0px; min-height: 519px"  onload="autoIframeHeight(this)"  src="/demo/demo-plugin_t_pqjw2m1652380690286_p_1652380693913/index.html"></iframe>'}};s.template=`<PreviewIframe class="demo-plugin_t_pqjw2m1652380690286_p_" idx="Demo0"  :source="source()" :sourceCode="sourceCode()">
...
</div></div><PagesRouter  docPath="guide/contributing/plugin.md" mapType="docs" docRepo="tinymce-plugin-docs" pagesName="plugin_t_pqjw2m1652380690286_p_" />`});export{p as default};
