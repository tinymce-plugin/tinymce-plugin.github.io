import"./pinia.js";import{M as s}from"./vue.js";const n=s({components:{},template:`<div class="fv-mardown-html"><div class="fv-mardown-main tp-doc"><h1 id="\u{1F680}tpImportword" tabindex="-1"><a class="header-anchor" href="#\u{1F680} tpImportword">#</a> \u{1F680} tpImportword</h1>
...
<a href="https://www.npmjs.com/package/@tinymce-plugin/tp-importword" target="_blank"><img src="https://img.shields.io/npm/v/@tinymce-plugin/tp-layout.svg" alt="release candidate"></a>\xA0
...
<a href="https://github.com/tinymce-plugin/tp-indent2em/blob/main/LICENSE" target="_blank"><img src="https://img.shields.io/github/license/tinymce-plugin/tp-layout.svg" alt="GitHub license"></a>\xA0
<a href="https://github.com/tinymce-plugin/tp-layout" target="_blank"><img src="https://img.shields.io/npm/dw/@tinymce-plugin/tp-layout" alt="tinymce Version"></a></p>
...
<pre class="hljs fv-hljs highlight-line"><ul class="highlight-line-number "  ><li ><span>1</span></li><li ><span>2</span></li><li ><span>3</span></li><li class="line"><span>4</span></li><li class="line"><span>5</span></li><li ><span>6</span></li><li ><span>7</span></li><li ><span>8</span></li><li ><span>9</span></li></ul><code class=" hljs  hljs-js" @click.stop="()=>{}"> <span class="hljs-keyword">import</span> <span class="hljs-string">&quot;@tinymce-plugin/tp-layout&quot;</span>;
 tinymce.<span class="hljs-title function_">init</span>({
  ...
   ...
   <span class="hljs-attr">plugins</span>: <span class="hljs-string">&quot;tpLayout&quot;</span>
   <span class="hljs-attr">toolbar</span>: <span class="hljs-string">&quot;tpLayout&quot;</span>
  ...
 })
</code><div class="language-text" >js</div></pre>
</div>
</div></div><PagesRouter  docPath="__docs__/introduction.md" mapType="docs" docRepo="tp-layout" pagesName="introduction_t_yfqr3n1659713320062_p_" />`});export{n as default};
