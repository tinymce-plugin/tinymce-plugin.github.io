...
`:"",n};const lt=(t,a,n)=>{!n&&(n=a*100);let e={id:null,outTime:n,outId:null};e.id=setInterval(i=>{t(()=>{clearTimeout(i.outId),clearInterval(i.id)})},a,e),e.outId=setTimeout(()=>{e.id&&clearInterval(e.id)},e.outTime)};let y=function(t,a){return typeof t[a]=="function"?t[a]:typeof g.customTags[t.name][a]=="function"?g.customTags[t.name][a]:function(){}};const rt=(t,a)=>a?typeof t=="string"&&!t.match(/\s/)&&t.length>0?parseInt(t)+"px":t:typeof t=="string"&&t.length>0&&t.match(/^[0-9]{1,8}$/)?t+"px":t,T=t=>{let a=t.split("_");return a.length>1?_.translate([a[0]+" {0}",a[1]]):_.translate(t)};tinymce.tp$HtmlPanelFn=window.tp$HtmlPanelFn=function(t,a,n){b.buttonsStyle&&(b.buttonsStyle[a]=n),document.querySelector("#"+a+"_StyleID").innerHTML=t.nextElementSibling.innerHTML};const ut={count:0},pt=t=>{let a=new Date().getTime()+"-"+ut.count++,n=`
...
`;return document.querySelector(t.selector).outerHTML=n+document.querySelector(t.selector).outerHTML,a},dt=(t,a,n)=>{let e="";e=b.buttonsStyle&&b.buttonsStyle[a],n||(n=A(t.tp$CustomTags.buttons.styleSheetList)),e||(e=b.buttonsStyle&&(b.buttonsStyle[a]=n[0]));let i="",o="",l="";return n.forEach((r,s)=>{r===e&&(o=`<span class="tp-buttons" data-tp-style="${r}">${T(r)}</span>`),i+=`<li ><input id="${a+"_"+s}" type="radio" name="${a}" ${e===r?" checked ":""}  onclick="tinymce.tp$HtmlPanelFn(this,'${a}','${r}')"> <label for="${a+"_"+s}" > <span class="tp-buttons" data-tp-style="${r}">${T(r)}</span></label></li>
`,l+=E(t.tp$CustomTags.buttons.styleSheetList[r],r)}),`<div style="width: 100%; position: relative; " >
  ...
  :host {
      overflow: hidden;
      display: block; 
  }`,o.innerHTML=e.template.innerHTML;class s extends t.HTMLElement{constructor(){super(),this.setAttribute("contenteditable",!1),this.setAttribute("data-mce-tp-component",i),this.attachShadow({mode:"open"}),this.tp$state=typeof e.state=="object"?JSON.parse(JSON.stringify(e.state)):{},z(n,this,"init",e),this.tpComponentDelete=typeof e.tpComponentDelete=="function"?e.tpComponentDelete.bind(this):()=>{this.remove()},this.tpComponentCmd=typeof e.tpComponentCmdFn=="object"?JSON.stringify(e.tpComponentCmdFn)!=="{}"?(d,x)=>{e.tpComponentCmdFn[d](this,x),z(n,this,d,e)}:(d,x)=>{g.customTags[i].tpComponentCmdFn[d](this,x),z(n,this,d,e)}:()=>{console.log("\u65E0\u53EF\u7528cmd")},r.id="tpComponentStyle_"+this.getAttribute("data-id"),i=="tabs"&&(r.textContent=e.styleSheetLoadList&&e.styleSheetLoadList[this.getAttribute("data-tp-style")||"default"]?e.styleSheetLoadList[this.getAttribute("data-tp-style")||"default"].replace(/.tp-tabs\s*\{/g,":host   {").replace(/.tp-tabs_label\b\s/g,"::slotted(.tp-tabs_label)   ").replace(/.tp-tabs_label:hover\b\s/g,"::slotted(.tp-tabs_label:hover)   ").replace(/.tp-tabs_label.checked\b\s/g,"::slotted(.tp-tabs_label.checked)   "):""),i=="collapse"&&(r.textContent=e.styleSheetLoadList&&e.styleSheetLoadList[this.getAttribute("data-tp-style")||"default"]?e.styleSheetLoadList[this.getAttribute("data-tp-style")||"default"].replace(/>/g," ").replace(/.tp-collapse\s*\{/g,":host   {").replace(/label.tp-collapse_label\b\s/g,"::slotted(.tp-collapse_label)   ").replace(/label.tp-collapse_label::/g,"::slotted(.tp-collapse_label)::").replace(/.tp-tabs_label:hover\b\s/g,"::slotted(.tp-tabs_label:hover)   ").replace(/.tp-tabs_label.checked\b\s/g,"::slotted(.tp-tabs_label.checked)   "):""),i=="buttons"&&(r.textContent=e.styleSheetList&&e.styleSheetList[this.getAttribute("data-tp-style")||"default"]?E(e.styleSheetList[this.getAttribute("data-tp-style")||"default"],this.getAttribute("data-tp-style")||"default").replace(/\[data-tp-style=(.*?)\]/g,"").replace(/>/g," ").replace(/.tp-buttons\s*\{/g,":host   {").replace(/.tp-buttons:hover\s*\{/g,":host(:hover)   {").replace(/.tp-buttons::before\s*\{/g,":host(.tp-buttons)::before   {").replace(/.tp-buttons::after\s*\{/g,":host(.tp-buttons)::after   {"):""),o.content.prepend(r),o.content.prepend(l),this.shadowRoot.appendChild(o.content.cloneNode(!0))}connectedCallback(){y(e,"headerEditableFn")(this,e.isHeaderEditable,i,n),y(e,"contentEditableFn")(this,e.isContentEditable,i,n),y(e,"connectedCallback")(this.shadowRoot,this)}static get observedAttributes(){return["data-top-bg","data-mce-tp-component","data-value"]}static tp$Delete(){console.log(this)}}try{t.customElements.define("tp-"+i,s)}catch{}},mt=t=>{const a=t.getWin(),n=t.getDoc();let e=t.toolbar,i=t.baseURI.source;typeof e=="object"&&(e=e.jion(" ")),/tpIconlists/.test(e)&&X.send({url:i+"plugins/tpIconlists/tpIconlists.css",async:!1,dataType:"text",success:function(r){t.dom.addStyle(r)}}),ht(t),ct(t);const o=`.mce-content-body [data-mce-tp-component][contenteditable=false][data-mce-selected] {
      outline: none;
      cursor: default;
  ...
  .mce-content-body *[contentEditable=false] *[contentEditable=true]:hover {
      outline: none!important;
  }`;t.dom.addStyle(o),t.tp$Style={},t.getTpStyle=r=>"<style>"+t.tp$OutputStyle+" </style>";let l=t.tp$CustomTags||g.customTags;S.each(l,function(r,s){gt(a,n,t,r,s)}),t.parser.addAttributeFilter("data-tp-component",r=>{r&&r.forEach(s=>{let u=s.attr("data-tp-component");l[u]&&y(l[u],"parserFn")(s,u,t)})}),t.serializer.addAttributeFilter("data-mce-tp-component",r=>{r&&r.forEach(s=>{let u=s.attr("data-mce-tp-component");l[u]&&y(l[u],"serializerFn")(s,u,t)})}),t.setContent(t.getContent({source_view:!0}))},I=(t,a,n,e,i)=>{e?(!e.tp$CustomTags&&(e.tp$CustomTags=JSON.parse(JSON.stringify(g.customTags))),i?m(e.tp$CustomTags[t][a],n):e.tp$CustomTags[t][a]=n):i?m(g.customTags[t][a],n):g.customTags[t][a]=n},M={custom_elements:"",setCustomTags:I,createCustomTags:(t,a,n)=>{n?(!n.tp$CustomTags&&(n.tp$CustomTags=JSON.parse(JSON.stringify(g.customTags))),n.tp$CustomTags[t]=a):g.customTags[t]=a},setStyleSheetList:(t,a,n,e)=>{I("buttons","styleSheetList",{[a]:{"tp-buttons":k("tp-buttons",n),"tp-buttons:hover":k("tp-buttons:hover",n),"tp-buttons::before":k("tp-buttons::before",n),"tp-buttons::after":k("tp-buttons::after",n)}},e,!0)},createHtmlPanel:dt};var $={name:"tabs",styleSheet:{selector:"default",styleSheetList:{default:{"tp-tabs":"","tp-tabs_top":"","tp-tabs_label.checked":" ","tp-tabs_main":" ","tp-tab_main.checked":" "}}},styleSheetLoadList:{},styleFn:()=>{},state:{count:0},tpComponentDeleteFn:function(){console.log(this)},tpComponentMonitorCmd:()=>{},tpComponentCmdFn:{tabAdd:(t,a)=>{let n=document.createElement("div");n.setAttribute("contenteditable",!1),n.setAttribute("class","tp-partition tp-tabs_label"),n.setAttribute("data-idx",t.tp$state.count);let e=document.createElement("p");e.setAttribute("class","tp-component_inline"),e.setAttribute("data-idx",t.tp$state.count),e.setAttribute("contenteditable",!0),e.innerHTML=a.title,n.appendChild(e),t.insertBefore(n,t.lastChild);let i=document.createElement("div");i.setAttribute("class","tp-tab_main"),i.setAttribute("style","overflow: hidden; max-height: 0; transition: all 0s"),i.innerHTML=a.content,t.lastChild.appendChild(i),t.tp$state.count++},tabDelete:(t,a)=>{t.children[--t.tp$state.count].remove(),t.lastChild.lastChild.remove()},delete:(t,a)=>{t.remove()},getStyle:(t,a)=>{},setStyle:(t,a)=>{console.log(t.querySelector(".tp-tabs_top")),t.setAttribute("data-top-style",a["tp-tabs_top"]),t.shadowRoot.querySelector(".tp-tabs_top").setAttribute("style",a["tp-tabs_top"])}},template:{innerHTML:`
<div class="tp-tabs">
...
</div>`;g.customTags[$.name]=$,g.customTags[V.name]=V,g.customTags[N.name]=N;let kt=(t,a,n)=>{let e=`
