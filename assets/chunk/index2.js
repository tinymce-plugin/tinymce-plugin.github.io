var Dt=(b,p)=>()=>(p||b((p={exports:{}}).exports,p),p.exports);var Ht=Dt((T,y)=>{/*! 
*  @plugin tinymce-plugin
*  @version 0.0.3-beta.21 (2022-7-5)
...
*/(function(b,p){typeof T=="object"&&typeof y!="undefined"?p(T):typeof define=="function"&&define.amd?define(["exports"],p):(b=typeof globalThis!="undefined"?globalThis:b||self,p(b.tinymcePlugin={}))})(globalThis,function(b){let p=tinymce,A=p.util.Tools,C=p.html.Node;p.html.Schema;let Y=p.util.XHR,L=p.util.I18n,Z=new p.html.Serializer().serialize,Q=new p.html.DomParser().parse,x={};window.tp$State=x;let h=(t,a)=>{let n=a?a.match(new RegExp(t+':(.+?)"?[;}]')):"";return n?n[1]:!1};function P(t,a,n,e){t.tp$Style.mapping&&t.tp$Style.mapping[""+a.getAttribute("data-id")]&&(t.tp$Style.mapping[""+a.getAttribute("data-id")].specialStyle[""+n]=e)}let g={customTags:{}},F=Object.keys,m=function(){return m=Object.assign||function(a){for(var n,e=1,i=arguments.length;e<i;e++){n=arguments[e];for(var o in n)Object.prototype.hasOwnProperty.call(n,o)&&(a[o]=n[o])}return a},m.apply(this,arguments)},tt=Object.hasOwnProperty;var et=function(t){return t==null},at=function(t){return!et(t)};const k=t=>{if(typeof t=="object")return JSON.stringify(t).replace(/"([-A-Za-z]+?)":""[,}]/g,"").replace(/,/gi,";").replace(/{/gi,"").replace(/}/gi,"").replace(/"/gi,"")},B=t=>typeof t=="string"&&t!=="{}"?(t=JSON.stringify(t),JSON.parse(("{"+t.replace(/:/g,'": "').replace(/;\s*/g,'","')+"}").replace(/,\"\"\}$/,"}"))):t,E=(t,a)=>{const n=a.match(new RegExp(`.${t}\\s*\\{([\\s\\S]+)\\}`));return n&&n[1]?n[1].replace(/\}([\s\S]+)/,"").trim():""};var nt=function(t,a){return tt.call(t,a)},it=function(t,a,n,e){e===void 0&&(e=null);var i=t.attr(n);return at(i)?i:nt(a,n)?null:e};const z=t=>t.replace(/[-|\_](\w)/g,function(a,n){return n.toUpperCase()}),ot=t=>t.replace(/([A-Z])/g,"_$1").toLowerCase().replace(/\-/g,"_"),st=t=>t.replace(/([A-Z])/g,"-$1").toLowerCase().replace(/\_/g,"-");var lt=function(t,a){let n="";if(!t)return"";for(a=z(a);t.nodeName!=="P"&&t.nodeName!=="LI"&&t.nodeName!=="DIV"&&t.nodeName!=="BODY";){if(t.style[a]){n=t.style[a];break}t=t.parentNode}return n};let w=(t,a)=>{let n="";return n+=t["tp-buttons"]?'.tp-buttons[data-tp-style="'+a+'"] {'+t["tp-buttons"]+`}
...
`:"",n};const rt=(t,a,n)=>{!n&&(n=a*100);let e={id:null,outTime:n,outId:null};e.id=setInterval(i=>{t(()=>{clearTimeout(i.outId),clearInterval(i.id)})},a,e),e.outId=setTimeout(()=>{e.id&&clearInterval(e.id)},e.outTime)};let v=function(t,a){return typeof t[a]=="function"?t[a]:typeof g.customTags[t.name][a]=="function"?g.customTags[t.name][a]:function(){}};const ut=(t,a)=>a?typeof t=="string"&&!t.match(/\s/)&&t.length>0?parseInt(t)+"px":t:typeof t=="string"&&t.length>0&&t.match(/^[0-9]{1,8}$/)?t+"px":t,I=t=>{let a=t.split("_");return a.length>1?L.translate([a[0]+" {0}",a[1]]):L.translate(t)};tinymce.tp$HtmlPanelFn=window.tp$HtmlPanelFn=function(t,a,n){x.buttonsStyle&&(x.buttonsStyle[a]=n),document.querySelector("#"+a+"_StyleID").innerHTML=t.nextElementSibling.innerHTML};const pt={count:0},dt=t=>{let a=new Date().getTime()+"-"+pt.count++,n=`
...
`;return document.querySelector(t.selector).outerHTML=n+document.querySelector(t.selector).outerHTML,a},ct=(t,a,n)=>{let e="";e=x.buttonsStyle&&x.buttonsStyle[a],n||(n=F(t.tp$CustomTags.buttons.styleSheetList)),e||(e=x.buttonsStyle&&(x.buttonsStyle[a]=n[0]));let i="",o="",l="";return n.forEach((r,s)=>{r===e&&(o=`<span class="tp-buttons" data-tp-style="${r}">${I(r)}</span>`),i+=`<li ><input id="${a+"_"+s}" type="radio" name="${a}" ${e===r?" checked ":""}  onclick="tinymce.tp$HtmlPanelFn(this,'${a}','${r}')"> <label for="${a+"_"+s}" > <span class="tp-buttons" data-tp-style="${r}">${I(r)}</span></label></li>
`,l+=w(t.tp$CustomTags.buttons.styleSheetList[r],r)}),`<div style="width: 100%; position: relative; " >
  ...
  :host {
      overflow: hidden;
      display: block; 
  }`,o.innerHTML=e.template.innerHTML;class s extends t.HTMLElement{constructor(){super(),this.setAttribute("contenteditable",!1),this.setAttribute("data-mce-tp-component",i),this.attachShadow({mode:"open"}),this.tp$state=typeof e.state=="object"?JSON.parse(JSON.stringify(e.state)):{},H(n,this,"init",e),this.tpComponentDelete=typeof e.tpComponentDelete=="function"?e.tpComponentDelete.bind(this):()=>{this.remove()},this.tpComponentCmd=typeof e.tpComponentCmdFn=="object"?JSON.stringify(e.tpComponentCmdFn)!=="{}"?(d,f)=>{e.tpComponentCmdFn[d](this,f),H(n,this,d,e)}:(d,f)=>{g.customTags[i].tpComponentCmdFn[d](this,f),H(n,this,d,e)}:()=>{console.log("\u65E0\u53EF\u7528cmd")},r.id="tpComponentStyle_"+this.getAttribute("data-id"),i=="tabs"&&(r.textContent=e.styleSheetLoadList&&e.styleSheetLoadList[this.getAttribute("data-tp-style")||"default"]?e.styleSheetLoadList[this.getAttribute("data-tp-style")||"default"].replace(/.tp-tabs\s*\{/g,":host   {").replace(/.tp-tabs_label\b\s/g,"::slotted(.tp-tabs_label)   ").replace(/.tp-tabs_label:hover\b\s/g,"::slotted(.tp-tabs_label:hover)   ").replace(/.tp-tabs_label.checked\b\s/g,"::slotted(.tp-tabs_label.checked)   "):""),i=="collapse"&&(r.textContent=e.styleSheetLoadList&&e.styleSheetLoadList[this.getAttribute("data-tp-style")||"default"]?e.styleSheetLoadList[this.getAttribute("data-tp-style")||"default"].replace(/>/g," ").replace(/.tp-collapse\s*\{/g,":host   {").replace(/label.tp-collapse_label\b\s/g,"::slotted(.tp-collapse_label)   ").replace(/label.tp-collapse_label::/g,"::slotted(.tp-collapse_label)::").replace(/.tp-tabs_label:hover\b\s/g,"::slotted(.tp-tabs_label:hover)   ").replace(/.tp-tabs_label.checked\b\s/g,"::slotted(.tp-tabs_label.checked)   "):""),i=="buttons"&&(r.textContent=e.styleSheetList&&e.styleSheetList[this.getAttribute("data-tp-style")||"default"]?w(e.styleSheetList[this.getAttribute("data-tp-style")||"default"],this.getAttribute("data-tp-style")||"default").replace(/\[data-tp-style=(.*?)\]/g,"").replace(/>/g," ").replace(/.tp-buttons\s*\{/g,":host   {").replace(/.tp-buttons:hover\s*\{/g,":host(:hover)   {").replace(/.tp-buttons::before\s*\{/g,":host(.tp-buttons)::before   {").replace(/.tp-buttons::after\s*\{/g,":host(.tp-buttons)::after   {"):""),o.content.prepend(r),o.content.prepend(l),this.shadowRoot.appendChild(o.content.cloneNode(!0))}connectedCallback(){v(e,"headerEditableFn")(this,e.isHeaderEditable,i,n),v(e,"contentEditableFn")(this,e.isContentEditable,i,n),v(e,"connectedCallback")(this.shadowRoot,this)}static get observedAttributes(){return["data-top-bg","data-mce-tp-component","data-value"]}static tp$Delete(){console.log(this)}}try{t.customElements.define("tp-"+i,s)}catch{}},bt=t=>{const a=t.getWin(),n=t.getDoc();let e=t.toolbar,i=t.baseURI.source;typeof e=="object"&&(e=e.jion(" ")),/tpIconlists/.test(e)&&Y.send({url:i+"plugins/tpIconlists/tpIconlists.css",async:!1,dataType:"text",success:function(r){t.dom.addStyle(r)}}),gt(t),ht(t);const o=`.mce-content-body [data-mce-tp-component][contenteditable=false][data-mce-selected] {
      outline: none;
      cursor: default;
  ...
  .mce-content-body *[contentEditable=false] *[contentEditable=true]:hover {
      outline: none!important;
  }`;t.dom.addStyle(o),t.tp$Style={},t.getTpStyle=r=>"<style>"+t.tp$OutputStyle+" </style>";let l=t.tp$CustomTags||g.customTags;A.each(l,function(r,s){mt(a,n,t,r,s)}),t.parser.addAttributeFilter("data-tp-component",r=>{r&&r.forEach(s=>{let u=s.attr("data-tp-component");l[u]&&v(l[u],"parserFn")(s,u,t)})}),t.serializer.addAttributeFilter("data-mce-tp-component",r=>{r&&r.forEach(s=>{let u=s.attr("data-mce-tp-component");l[u]&&v(l[u],"serializerFn")(s,u,t)})}),t.setContent(t.getContent({source_view:!0}))},$=(t,a,n,e,i)=>{e?(!e.tp$CustomTags&&(e.tp$CustomTags=JSON.parse(JSON.stringify(g.customTags))),i?m(e.tp$CustomTags[t][a],n):e.tp$CustomTags[t][a]=n):i?m(g.customTags[t][a],n):g.customTags[t][a]=n},V={custom_elements:"",setCustomTags:$,createCustomTags:(t,a,n)=>{n?(!n.tp$CustomTags&&(n.tp$CustomTags=JSON.parse(JSON.stringify(g.customTags))),n.tp$CustomTags[t]=a):g.customTags[t]=a},setStyleSheetList:(t,a,n,e)=>{$("buttons","styleSheetList",{[a]:{"tp-buttons":E("tp-buttons",n),"tp-buttons:hover":E("tp-buttons:hover",n),"tp-buttons::before":E("tp-buttons::before",n),"tp-buttons::after":E("tp-buttons::after",n)}},e,!0)},createHtmlPanel:ct};var N={name:"tabs",styleSheet:{selector:"default",styleSheetList:{default:{"tp-tabs":"","tp-tabs_top":"","tp-tabs_label.checked":" ","tp-tabs_main":" ","tp-tab_main.checked":" "}}},styleSheetLoadList:{},styleFn:()=>{},state:{count:0},tpComponentDeleteFn:function(){console.log(this)},tpComponentMonitorCmd:()=>{},tpComponentCmdFn:{tabAdd:(t,a)=>{let n=document.createElement("div");n.setAttribute("contenteditable",!1),n.setAttribute("class","tp-partition tp-tabs_label"),n.setAttribute("data-idx",t.tp$state.count);let e=document.createElement("p");e.setAttribute("class","tp-component_inline"),e.setAttribute("data-idx",t.tp$state.count),e.setAttribute("contenteditable",!0),e.innerHTML=a.title,n.appendChild(e),t.insertBefore(n,t.lastChild);let i=document.createElement("div");i.setAttribute("class","tp-tab_main"),i.setAttribute("style","overflow: hidden; max-height: 0; transition: all 0s"),i.innerHTML=a.content,t.lastChild.appendChild(i),t.tp$state.count++},tabDelete:(t,a)=>{t.children[--t.tp$state.count].remove(),t.lastChild.lastChild.remove()},delete:(t,a)=>{t.remove()},getStyle:(t,a)=>{},setStyle:(t,a)=>{console.log(t.querySelector(".tp-tabs_top")),t.setAttribute("data-top-style",a["tp-tabs_top"]),t.shadowRoot.querySelector(".tp-tabs_top").setAttribute("style",a["tp-tabs_top"])}},template:{innerHTML:`
<div class="tp-tabs">
...
<div class="tp-collapse_mainBox">
    ...
    `},isContentEditable:!0,connectedCallback:()=>{},tpComponentCmdFn:{upData:(t,a)=>{let n=a.style,e=h("padding",n),i=h("border",n),o=h("border-width",n);P(a.editor,t,"tp-collapse_main",(e?"padding: "+e+"!important; ":"")+(i?"border: "+i+"!important;":"")+(o?"border-width: "+o+"!important;":""))}},contentEditableFn:(t,a,n,e)=>{const i=document.createElement("div");if(i.setAttribute("contenteditable",!1),i.setAttribute("class","tp-partition tp-collapse_main"),a&&t.lastChild.setAttribute("contenteditable",!0),t.lastChild.getAttribute("class")==="tp-collapse_main"){let o=t.lastChild.getAttribute("style"),l=h("padding",o),r=h("border",o),s=h("border-width",o);P(e,t,"tp-collapse_main",(l?"padding: "+l+"!important; ":"")+(r?"border: "+r+"!important;":"")+(s?"border-width: "+s+"!important;":""))}i.appendChild(t.lastChild),t.appendChild(i)},isHeaderEditable:!0,headerEditableFn:(t,a,n,e)=>{if(t.firstChild.contenteditable!=="true"){const i=document.createElement("div");for(a&&i.setAttribute("contenteditable",!0),i.setAttribute("slot","header"),i.setAttribute("class","tp-collapse_label"),i.setAttribute("style","min-height: 20px; "+t.getAttribute("data-top-style"));t.firstChild&&t.firstChild.className!=="tp-"+n+"_main";)i.appendChild(t.firstChild);t.insertBefore(i,t.firstChild)}},parserFn:(t,a)=>{t.attr({"data-tp-component":null,"data-mce-tp-component":a}),t.attr("data-id",t.firstChild.attr("id")),t.firstChild.remove(),t.lastChild.attr("class","tp-"+a+"_main"),t.type=1,t.name="tp-"+a},serializerFn:(t,a)=>{t.attr({"data-mce-tp-component":null,"data-tp-component":a,contenteditable:null,class:"tp-"+a}),t.firstChild.type=1,t.firstChild.name="label",t.firstChild.attr({contenteditable:null,for:t.attr("data-id")});let n=t.lastChild.attr("style");t.lastChild.unwrap(),t.lastChild.attr({contenteditable:null,class:"tp-"+a+"_main",style:n});let e=new C("input",1);e.shortEnded=!0,e.attr({id:t.attr("data-id"),type:"checkbox"}),t.insert(e,t.firstChild,!0),t.attr("data-id",null),t.type=1,t.name="div"}};const j=t=>/select$/.test(t),U={forecolor:!0,backcolor:!0,tpLetterspacing:!0,tpIconlists:!0,tpColumns:!0,table:!0},S={title:{file:{zh_CN:"\u6587\u4EF6",en_US:"File"},edit:{zh_CN:"\u7F16\u8F91",en_US:"Edit"},view:{zh_CN:"\u67E5\u770B",en_US:"View"},insert:{zh_CN:"\u63D2\u5165",en_US:"Insert"},format:{zh_CN:"\u683C\u5F0F",en_US:"Format"},table:{zh_CN:"\u8868\u683C",en_US:"Table"},tools:{zh_CN:"\u5DE5\u5177",en_US:"Tools"},help:{zh_CN:"\u5E2E\u52A9",en_US:"Help"}},items:{code:"tools",spellchecker:"tools",spellcheckerlanguage:"tools",wordcount:"tools",image:"insert",link:"insert",media:"insert",hr:"insert",template:"insert",codesample:"insert",charmap:"insert",inserttable:"table",emoticons:"insert",pagebreak:"insert",nonbreaking:"insert",anchor:"insert",toc:"insert",insertdatetime:"insert",bold:"format",italic:"format",underline:"format",strikethrough:"format",blockquote:"format",subscript:"format",superscript:"format",removeformat:"format",formatselect:"format",fontselect:"format",fontsizes:"format",forecolor:"format",backcolor:"format",fontformats:"format",blockformats:"format",codeformat:"format",align:"format",table:"table",lineheight:"format",help:"help"}},J={file:!0,view:!0,edit:!0},K=t=>{let a=[];return t.split("|").forEach(e=>{let i=e.split(" "),o=[];i.forEach(l=>{l&&o.push({isSelect:j(l),name:l}),l&&S.items[l]&&(J[S.items[l]]=!0)}),o.length>0&&a.push(o)}),a},xt=t=>{let a=[];return t.split("|").forEach(e=>{let i=e.split(" "),o=[];i.forEach(l=>{l&&o.push({isSelect:j(l),name:l})}),a.push(o)}),a},W=()=>`.skt-tox-tinymce{
  ...
  .skt-loading .skeleton.badge:after {
  background-color: #f8fafc
  }`,ft=t=>{if(!document.querySelector("style#skt-tox-style")){let s=document.createElement("style");s.type="text/css",s.id="skt-tox-style";try{s.appendChild(document.createTextNode(W()))}catch{s.styleSheet.cssText=W()}document.getElementsByTagName("head")[0].appendChild(s)}if(!document.querySelector("style#skt-dark-tox-style")){let s=document.createElement("style");s.type="text/css",s.id="skt-dark-tox-style";try{s.appendChild(document.createTextNode(q()))}catch{s.styleSheet.cssText=q()}document.getElementsByTagName("head")[0].appendChild(s)}let a=[];typeof t.toolbar=="string"?a=K(t.toolbar):Array.isArray(t.toolbar)&&t.toolbar.forEach(s=>{a.push(...K(s))});let n=[];if(t.menubar!==!1)if(typeof t.menubar=="string")n=xt(t.menubar);else for(let s in S.title)J[s]&&n.push(S.title[s][t.language||"en_US"]);let e=t.min_height||t.height||200,i=[],o=e-150;for(let s=0;s<o;s+=50)i.push("1");let l=t.selector?document.querySelector(t.selector).parentNode:t.target.parentNode,r=document.createElement("div");return r.className="skt skt-loading",/dark$/.test(t.skin)&&r.setAttribute("data-isdark","true"),r.innerHTML=kt({selector:t.selector,toolbar:a,menubar:n,branding:t.branding!==!1,placeholderList:i,height:e}),l.style.position="relative",l.style.minHeight=e+"px",l.append(r),r},yt=t=>{let a="";return t.forEach(n=>{typeof n=="object"?n.forEach(e=>{a+='<button  class="skt-tox-mbtn skt-tox-mbtn--select"><span class="skt-tox-mbtn__select-label skeleton">'+e+`</span></button>
`}):a+='<button  class="skt-tox-mbtn skt-tox-mbtn--select"><span class="skt-tox-mbtn__select-label skeleton">'+n+`</span></button>
`}),a},Ct=t=>{let a="";return t.forEach(n=>{a+=`<div class="skt-tox-toolbar__group">
`,n.forEach(e=>{a+='<button class="skt-tox-tbtn '+(e.isSelect?" skt-tox-tbtn--select":"")+(U[e.name]?" skt-tox-split-button":"")+'"><span class="'+(e.isSelect?"skt-tox-tbtn__select-label skt-tox-tbtn--select":"skt-tox-icon tox-tbtn__icon-wrap")+' skeleton">'+e.name+"</span>"+(e.isSelect||U[e.name]?'<div class="skt-tox-tbtn__select-chevron skeleton"></div>':"")+`</button>
`}),a+=`</div>
`}),a},vt=t=>{let a="";return t.forEach(n=>{a+=`<p class="skeleton"></p>
`}),a},kt=t=>`
...
</div>`;g.customTags[N.name]=N,g.customTags[R.name]=R,g.customTags[O.name]=O;let Et=(t,a,n)=>{let e=`
`;for(let i=0;i<n;i++)e+=`.tp-${t} > input:nth-child(${i+1}):checked ~ .tp-${t}_top > .tp-${t}_label:nth-child(${i+1}){${a}}
            ...
            `;return e},wt=(t,a)=>{let n="";return F(t.specialStyle).forEach(e=>{n+=t.specialStyle[e]?`
 `+a[e]+" { "+t.specialStyle[e]+"} ":""}),n},St=t=>{t.tp$OutputStyle="";let a=2,n="",e="",i="",o="",l={},r={},s={};t.tp$Style&&t.tp$Style.mapping&&(!t.tp$CustomTags&&(t.tp$CustomTags=JSON.parse(JSON.stringify(g.customTags))),F(t.tp$Style.mapping).forEach(f=>{let c=t.tp$Style.mapping[f];c.styleCustomTags==="tabs"&&(l[c.styleTemplate]||(n=t.tp$CustomTags[c.styleCustomTags][c.stylePath][c.styleTemplate],l[c.styleTemplate]=!0),a<c.quantity&&(a=c.quantity)),c.styleCustomTags==="collapse"&&(r[c.styleTemplate]||(i+=t.tp$CustomTags[c.styleCustomTags][c.stylePath][c.styleTemplate],r[c.styleTemplate]=!0),o+=c.specialStyle?wt(c,{"tp-collapse_main":'.tp-collapse > input[id="'+f+'"]:checked + .tp-collapse_label + .tp-collapse_main'}):""),c.styleCustomTags==="buttons"&&!s[c.styleTemplate]&&(e+=w(t.tp$CustomTags[c.styleCustomTags][c.stylePath][c.styleTemplate],c.styleTemplate),s[c.styleTemplate]=!0)}));let u="",d="";n&&(n=n.replace(/.tp-tabs\s*{/g,"div.tp-tabs[data-id] {").replace(/\n.tp-tabs\s/g,`
.tp-tabs[data-id] `)+`.tp-tabs[data-id] > input { display: none;} 
 .tp-tabs .tp-tabs_main .tp-tab_main { overflow: hidden;max-height: 0px;}`,u=n.match(/.tp-tabs_label.checked\s*{\n([\s\S]+)\n}/)[1],d=u?Et("tabs",u,a):""),t.tp$OutputStyle=(e?`@font-face {
...
}`:"")+e+i+o+n+d};const _t={iframeLayout:`
   <style>
