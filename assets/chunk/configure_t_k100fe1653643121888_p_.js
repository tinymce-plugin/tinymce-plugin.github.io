...
</code><div class="language-text" >html</div></pre>`},sourceCode(){return'<iframe scrolling="no" style="width:100%;margin:auto 0;border:0px; min-height: 319px"  onload="autoIframeHeight(this)"  src="/demo/demo-configure_t_k100fe1653643121888_p_1653643125971/index.html"></iframe>'}};s.template=`<PreviewIframe class="demo-configure_t_k100fe1653643121888_p_" idx="Demo0"  :source="source()" :sourceCode="sourceCode()">
...
</div></div><PagesRouter  docPath="__docs__/configure.md" mapType="docs" docRepo="tp-importword" pagesName="configure_t_k100fe1653643121888_p_" />`});export{p as default};
