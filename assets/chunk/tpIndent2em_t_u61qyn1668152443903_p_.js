...
</code><div class="language-text" >html</div></pre>`},sourceCode(){return'<iframe scrolling="no" width="100%" style="width:100%;margin:auto 0;border:0px; min-height: 319px"  onload="autoIframeHeight(this)"  src="/demo/demo-tpIndent2em_t_u61qyn1668152443903_p_1668152450787/index.html"></iframe>'}};p.template=`<PreviewIframe class="demo-tpIndent2em_t_u61qyn1668152443903_p_" idx="Demo0"  :source="source()" :sourceCode="sourceCode()">
...
</code><div class="language-text" >vue</div></pre>`}};n.template=`<Preview class="demo-tpIndent2em_t_u61qyn1668152443903_p_" :source="source()">
...
</code><div class="language-text" >vue</div></pre>`}};a.template=`<PreviewVue2 class="demo-tpIndent2em_t_u61qyn1668152443903_p_"  :template="template()"  :source="source()">
...
</code><div class="language-text" >html</div></pre>`},sourceCode(i){class e extends s.Component{constructor(c){super(c),this.state={reactDemoInitialValue:"<p>\u8FD9\u662F\u4E00\u4E2AREactDemo</p>"},this.reactDemoInit={min_height:220,base_url:"/tinymce",branding:!1,language:"zh_CN",menubar:!1,skeletonScreen:!0,plugins:"code tpIndent2em autoresize",toolbar:"undo redo code tpIndent2em",content_style:"body { font-family:Helvetica,Arial,sans-serif; font-size:14px }"},this.handleChange=h=>{this.setState({reactDemoInitialValue:h})}}render(){return s.createElement("div",null,s.createElement("h1",null,"\u8FD9\u662F\u4E00\u4E2A\u9996\u884C\u7F29\u8FDB\u63D2\u4EF6"),s.createElement("div",null,s.createElement(r,{initialValue:this.state.reactDemoInitialValue,init:this.reactDemoInit,onEditorChange:this.handleChange})),s.createElement("div",{dangerouslySetInnerHTML:{__html:this.state.reactDemoInitialValue}}))}}return o.render(s.createElement(e,null),i)}};t.template=`<PreviewReact class="demo-tpIndent2em_t_u61qyn1668152443903_p_" idx="Demo3"  :source="source()">
                              
                            </PreviewReact>`;const x=j({components:{Demo0:p,Demo1:n,Demo2:a,Demo3:t},template:`<div class="fv-mardown-html"><div class="fv-mardown-main tp-doc"><h1 id="\u{1F680}tpIndent2em" tabindex="-1"><a class="header-anchor" href="#\u{1F680} tpIndent2em">#</a> \u{1F680} tpIndent2em</h1>
...
<Demo1 data-isComponent="vue" class="demo-tpIndent2em_t_u61qyn1668152443903_p_" />
 </demoGroupItem>
 <demoGroupItem title="Vue2">
<Demo2 data-isComponent="vue" class="demo-tpIndent2em_t_u61qyn1668152443903_p_" />
 </demoGroupItem>
 <demoGroupItem title="React">
<Demo3  data-isComponent="react"  class="demo-tpIndent2em_t_u61qyn1668152443903_p_" />
 </demoGroupItem>
</demoGroup></div></div><PagesRouter  docPath="__docs__/tpIndent2em.md" mapType="docs" docRepo="tp-indent2em" pagesName="tpIndent2em_t_u61qyn1668152443903_p_" />`});export{x as default};
