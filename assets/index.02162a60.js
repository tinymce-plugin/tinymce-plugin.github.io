import { T as TinymceEditor } from "./zh_CN.f5f47008.js";
import "./tpImportword.b64f5c97.js";
import { _ as _export_sfc, r as resolveComponent, c as createElementBlock, b as createBaseVNode, a as createVNode, p as pushScopeId, d as popScopeId, o as openBlock } from "./index.35146aad.js";
var skin_min = "";
var tpIconlists = "";
var iconfont = "";
var tpTabs = "";
...
<p style="margin-top: 0px;">\u554A\u58EB\u5927\u592B\u8270\u82E6\u54C8\u6570\u636E\u8FD4\u56DE\u7684\u662F\u4F0F\u864E\u7684\u723D\u80A4\u6C34u\u554A\u58EB\u5927\u592B\u5580\u4EC0\u80AF\u5FB7\u57FA\u54C8\u8428\u514B\u63A5\u7535\u8BDD\u770B\u6492\u53EF\u89C1\u5EA6\u8D3A\u5361\u6536\u5230\u5C3D\u5FEB\u54C8\u6492\u53EF\u89C1\u5EA6v\u5427\u554A\u5C31\u662F\u8D37\u8BB0\u5361\u548C\u6570\u636E\u5E93\u5927\u82CF\u6253 kjahscjkhaxjzcb\u963F\u65AF\u8482\u82AC\u62C9\u8428xcasdfdsfdsf</p>`,
      ...
      vueDemoOpt2: {
            ...
            items: [
              {
                ...
                onAction: function(editor, value) {
                  editor.formatter.apply("fontsize", { value });
                }
              },
              {
                icon: "underline",
        ...
        base_url: "/tinymce",
        plugins: "code  tpIndent2em tpLetterspacing autoresize  lists advlist tpImportword  tpCollapse tpTabs tpButtons tpIconlists  tpColumns tpParagraph tpIconfont preview",
        toolbar: ["code formatselect fontselect  fontsizeselect  forecolor backcolor bold italic underline strikethrough tpIndent2em tpLetterspacing tpImportword  tpCollapse tpTabs tpButtons tpIconlists  tpColumns tpParagraph tpIconfont mygroups Preview"]
      }
    };
  },
  methods: {
    ...
    init() {
      ...
      that.vueDemoOpt = {
        ...
        skeletonScreen: true,
        images_upload_handler: function(blobInfo, succFun, failFun2, progressCallback2) {
          ...
          that.$http({
            ...
            onUploadProgress(progress) {
              progressCallback2(progress + "%");
            }
          }).then(function(res) {
            if (res.code == 200) {
              succFun(_result);
            } else {
              failFun2("\u4E0A\u4F20\u5931\u8D25:" + data.data);
            }
          }).catch(function(error) {
            failFun2("\u4E0A\u4F20\u5931\u8D25:" + error.message);
          });
        ...
        tp_attachment_upload_handler: function(file, succFun, failFun2, progressCallback2) {
          var data = new FormData();
          data.append("file", file);
          that.$http({
            data,
            ...
            xhr: that.xhrOnProgress(function(e) {
              const percent = (e.loaded / e.total * 100 | 0) + "%";
              progressCallback2(percent);
            })
          }).then(function(data2) {
            if (data2.code == 200) {
              succFun(data2.data);
            } else {
              failFun2("\u4E0A\u4F20\u5931\u8D25:" + data2.data);
            }
          }).catch(function(error) {
            failFun2("\u4E0A\u4F20\u5931\u8D25:" + error.message);
          });
...
const _withScopeId = (n) => (pushScopeId("data-v-c490924e"), n = n(), popScopeId(), n);
const _hoisted_1 = { class: "vueDemo2" };
const _hoisted_2 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("h1", null, "\u5C55\u793A\u663E\u793A2", -1));
const _hoisted_3 = ["innerHTML"];
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_tinymce_vue = resolveComponent("tinymce-vue");
  const _component_PagesRouter = resolveComponent("PagesRouter");
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("div", _hoisted_1, [
      createVNode(_component_tinymce_vue, {
        modelValue: $data.content2,
        "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => $data.content2 = $event),
        init: $data.vueDemoOpt2
      }, null, 8, ["modelValue", "init"])
    ]),
    _hoisted_2,
    createBaseVNode("div", { innerHTML: $data.content2 }, null, 8, _hoisted_3),
    createVNode(_component_PagesRouter, { pagesName: "vuedemo" })
  ]);
}
var index = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-c490924e"]]);
